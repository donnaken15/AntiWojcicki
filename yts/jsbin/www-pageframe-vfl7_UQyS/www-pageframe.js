...
;function tb(a){var b=b||0;return function(){return a.apply(this,Array.prototype.slice.call(arguments,0,b))}}
...
function Eb(a,b){for(var c=0,d=vb(String(a)).split("."),e=vb(String(b)).split("."),f=Math.max(d.length,e.length),g=0;0==c&&g<f;g++){var k=d[g]||"",l=e[g]||"";do{k=/(\d*)(\D*)(.*)/.exec(k)||["","","",""];l=/(\d*)(\D*)(.*)/.exec(l)||["","","",""];if(0==k[0].length&&0==l[0].length)break;c=Fb(0==k[1].length?0:parseInt(k[1],10),0==l[1].length?0:parseInt(l[1],10))||Fb(0==k[2].length,0==l[2].length)||Fb(k[2],l[2]);k=k[3];l=l[3]}while(0==c)}return c}
function Fb(a,b){return a<b?-1:a>b?1:0}
;var Gb;a:{var Hb=n.navigator;if(Hb){var Ib=Hb.userAgent;if(Ib){Gb=Ib;break a}}Gb=""}function C(a){return-1!=Gb.indexOf(a)}
;function Jb(a,b,c){for(var d in a)b.call(c,a[d],d,a)}
function Kb(a,b,c){var d={},e;for(e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d}
function Lb(a){var b=0,c;for(c in a)b++;return b}
function Mb(a,b){a:{for(c in a)if(a[c]==b){var c=!0;break a}c=!1}return c}
function Nb(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b}
function Ob(a){var b=[],c=0,d;for(d in a)b[c++]=d;return b}
...
function Vb(a){var b=Ea(a);if("object"==b||"array"==b){if(Ha(a.clone))return a.clone();b="array"==b?[]:{};for(var c in a)b[c]=Vb(a[c]);return b}return a}
...
function Yb(a){var b=arguments.length;if(1==b&&Fa(arguments[0]))return Yb.apply(null,arguments[0]);for(var c={},d=0;d<b;d++)c[arguments[d]]=!0;return c}
;function Zb(){return C("Firefox")||C("FxiOS")}
function $b(){return C("Safari")&&!(ac()||C("Coast")||C("Opera")||C("Edge")||C("Edg/")||C("OPR")||Zb()||C("Silk")||C("Android"))}
function ac(){return(C("Chrome")||C("CriOS"))&&!C("Edge")}
function bc(){return C("Android")&&!(ac()||Zb()||C("Opera")||C("Silk"))}
...
function xc(a){if(a instanceof uc)return a;var b="object"==typeof a,c=null;b&&a.Qb&&(c=a.f());return yc(wb(b&&a.Ka?a.Aa():String(a)),c)}
...
Cc("<!DOCTYPE html>",0);var Ac=Cc("",0),Dc=Cc("<br>",0);var Ec=ub(function(){var a=document.createElement("div"),b=document.createElement("div");b.appendChild(document.createElement("div"));a.appendChild(b);b=a.firstChild.firstChild;a.innerHTML=wc(Ac);return!b.parentElement});
...
function Mc(a){return a=wb(a,void 0)}
...
;var Yc=C("Opera"),D=C("Trident")||C("MSIE"),Zc=C("Edge"),$c=Zc||D,ad=C("Gecko")&&!(-1!=Gb.toLowerCase().indexOf("webkit")&&!C("Edge"))&&!(C("Trident")||C("MSIE"))&&!C("Edge"),bd=-1!=Gb.toLowerCase().indexOf("webkit")&&!C("Edge"),cd=C("Macintosh"),dd=C("Windows"),ed=C("Android"),fd=Sc(),gd=C("iPad"),hd=C("iPod"),id=Tc();function jd(){var a=n.document;return a?a.documentMode:void 0}
var kd;a:{var ld="",md=function(){var a=Gb;if(ad)return/rv:([^\);]+)(\)|;)/.exec(a);if(Zc)return/Edge\/([\d\.]+)/.exec(a);if(D)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(bd)return/WebKit\/(\S+)/.exec(a);if(Yc)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
md&&(ld=md?md[1]:"");if(D){var nd=jd();if(null!=nd&&nd>parseFloat(ld)){kd=String(nd);break a}}kd=ld}var od=kd,Xc={};function pd(a){return Wc(a,function(){return 0<=Eb(od,a)})}
function qd(a){return Number(rd)>=a}
var sd;sd=n.document&&D?jd():void 0;var rd=sd;var td=Zb(),ud=Sc()||C("iPod"),vd=C("iPad"),wd=bc(),yd=ac(),zd=$b()&&!Tc();var Ad={},Bd=null;var Cd=window;var Dd={};function Ed(a){this.f=a||{cookie:""}}
...
"")};
h.get=function(a,b){for(var c=a+"=",d=(this.f.cookie||"").split(";"),e=0,f;e<d.length;e++){f=vb(d[e]);if(0==f.lastIndexOf(c,0))return f.substr(c.length);if(f==a)return""}return b};
...
function Fd(a){a=(a.f.cookie||"").split(";");for(var b=[],c=[],d,e,f=0;f<a.length;f++)e=vb(a[f]),d=e.indexOf("="),-1==d?(b.push(""),c.push(e)):(b.push(e.substring(0,d)),c.push(e.substring(d+1)));return{keys:b,values:c}}
...
function Ud(a,b){Jb(b,function(c,d){c&&"object"==typeof c&&c.Ka&&(c=c.Aa());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:Vd.hasOwnProperty(d)?a.setAttribute(Vd[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
function ae(a,b,c){var d=arguments,e=document,f=String(d[0]),g=d[1];if(!Hd&&g&&(g.name||g.type)){f=["<",f];g.name&&f.push(' name="',Mc(g.name),'"');if(g.type){f.push(' type="',Mc(g.type),'"');var k={};Xb(k,g);delete k.type;g=k}f.push(">");f=f.join("")}f=be(e,f);g&&("string"===typeof g?f.className=g:Fa(g)?f.className=g.join(" "):Ud(f,g));2<d.length&&ce(e,f,d);return f}
...
return a}
var Ue={zf:"allow-forms",Af:"allow-modals",Bf:"allow-orientation-lock",Cf:"allow-pointer-lock",Df:"allow-popups",Ef:"allow-popups-to-escape-sandbox",Ff:"allow-presentation",Gf:"allow-same-origin",Hf:"allow-scripts",If:"allow-top-navigation",Jf:"allow-top-navigation-by-user-activation"},We=ub(function(){return Ve()});
...
;Yb("A AREA BUTTON HEAD INPUT LINK MENU META OPTGROUP OPTION PROGRESS STYLE SELECT SOURCE TEXTAREA TITLE TRACK".split(" "));function Cf(){}
Cf.prototype.f=null;Cf.prototype.getOptions=function(){var a;(a=this.f)||(a={},Df(this)&&(a[0]=!0,a[1]=!0),a=this.f=a);return a};var Ef;function Ff(){}
A(Ff,Cf);function Gf(a){return(a=Df(a))?new ActiveXObject(a):new XMLHttpRequest}
function Df(a){if(!a.g&&"undefined"==typeof XMLHttpRequest&&"undefined"!=typeof ActiveXObject){for(var b=["MSXML2.XMLHTTP.6.0","MSXML2.XMLHTTP.3.0","MSXML2.XMLHTTP","Microsoft.XMLHTTP"],c=0;c<b.length;c++){var d=b[c];try{return new ActiveXObject(d),a.g=d}catch(e){}}throw Error("Could not create ActiveXObject. ActiveX might be disabled, or MSXML might not be installed");}return a.g}
Ef=new Ff;function Hf(){this.G=this.G;this.C=this.C}
Hf.prototype.G=!1;Hf.prototype.K=function(){return this.G};
Hf.prototype.dispose=function(){this.G||(this.G=!0,this.B())};
function If(a,b){a.G?b():(a.C||(a.C=[]),a.C.push(b))}
Hf.prototype.B=function(){if(this.C)for(;this.C.length;)this.C.shift()()};
function Jf(a){a&&"function"==typeof a.dispose&&a.dispose()}
;function Kf(a,b){this.type=a;this.currentTarget=this.target=b;this.defaultPrevented=this.f=!1}
Kf.prototype.stopPropagation=function(){this.f=!0};
Kf.prototype.preventDefault=function(){this.defaultPrevented=!0};var Lf=!D||qd(9),Mf=D&&!pd("9"),Nf=function(){if(!n.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
try{n.addEventListener("test",u,b),n.removeEventListener("test",u,b)}catch(c){}return a}();var Of;Of=bd?"webkitTransitionEnd":Yc?"otransitionend":"transitionend";function Pf(a,b){Kf.call(this,a?a.type:"");this.relatedTarget=this.currentTarget=this.target=null;this.button=this.screenY=this.screenX=this.clientY=this.clientX=0;this.key="";this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.state=null;this.pointerId=0;this.pointerType="";this.g=null;a&&this.init(a,b)}
A(Pf,Kf);var Qf={2:"touch",3:"pen",4:"mouse"};
Pf.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.currentTarget=b;var e=a.relatedTarget;e?ad&&(Vc(e,"nodeName")||(e=null)):"mouseover"==c?e=a.fromElement:"mouseout"==c&&(e=a.toElement);this.relatedTarget=e;d?(this.clientX=void 0!==d.clientX?d.clientX:d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||0):(this.clientX=void 0!==a.clientX?
a.clientX:a.pageX,this.clientY=void 0!==a.clientY?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0);this.button=a.button;this.keyCode=a.keyCode||0;this.key=a.key||"";this.charCode=a.charCode||("keypress"==c?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.pointerId=a.pointerId||0;this.pointerType="string"===typeof a.pointerType?a.pointerType:Qf[a.pointerType]||"";this.state=a.state;this.g=a;a.defaultPrevented&&this.preventDefault()};
Pf.prototype.stopPropagation=function(){Pf.H.stopPropagation.call(this);this.g.stopPropagation?this.g.stopPropagation():this.g.cancelBubble=!0};
Pf.prototype.preventDefault=function(){Pf.H.preventDefault.call(this);var a=this.g;if(a.preventDefault)a.preventDefault();else if(a.returnValue=!1,Mf)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(b){}};var Rf="closure_listenable_"+(1E6*Math.random()|0),Sf=0;function Tf(a,b,c,d,e){this.listener=a;this.f=null;this.src=b;this.type=c;this.capture=!!d;this.yb=e;this.key=++Sf;this.Ua=this.sb=!1}
function Uf(a){a.Ua=!0;a.listener=null;a.f=null;a.src=null;a.yb=null}
;function Vf(a){this.src=a;this.listeners={};this.f=0}
Vf.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.f++);var g=Wf(a,b,d,e);-1<g?(b=a[g],c||(b.sb=!1)):(b=new Tf(b,this.src,f,!!d,e),b.sb=c,a.push(b));return b};
Vf.prototype.remove=function(a,b,c,d){a=a.toString();if(!(a in this.listeners))return!1;var e=this.listeners[a];b=Wf(e,b,c,d);return-1<b?(Uf(e[b]),kb(e,b),0==e.length&&(delete this.listeners[a],this.f--),!0):!1};
function Xf(a,b){var c=b.type;c in a.listeners&&jb(a.listeners[c],b)&&(Uf(b),0==a.listeners[c].length&&(delete a.listeners[c],a.f--))}
function Wf(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.Ua&&f.listener==b&&f.capture==!!c&&f.yb==d)return e}return-1}
;var Yf="closure_lm_"+(1E6*Math.random()|0),Zf={},$f=0;function bg(a,b,c,d,e){if(d&&d.once)return cg(a,b,c,d,e);if(Fa(b)){for(var f=0;f<b.length;f++)bg(a,b[f],c,d,e);return null}c=dg(c);return a&&a[Rf]?a.h.add(String(b),c,!1,Ia(d)?!!d.capture:!!d,e):eg(a,b,c,!1,d,e)}
function eg(a,b,c,d,e,f){if(!b)throw Error("Invalid event type");var g=Ia(e)?!!e.capture:!!e,k=fg(a);k||(a[Yf]=k=new Vf(a));c=k.add(b,c,d,g,f);if(c.f)return c;d=gg();c.f=d;d.src=a;d.listener=c;if(a.addEventListener)Nf||(e=g),void 0===e&&(e=!1),a.addEventListener(b.toString(),d,e);else if(a.attachEvent)a.attachEvent(hg(b.toString()),d);else if(a.addListener&&a.removeListener)a.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");$f++;return c}
function gg(){var a=ig,b=Lf?function(c){return a.call(b.src,b.listener,c)}:function(c){c=a.call(b.src,b.listener,c);
if(!c)return c};
return b}
function cg(a,b,c,d,e){if(Fa(b)){for(var f=0;f<b.length;f++)cg(a,b[f],c,d,e);return null}c=dg(c);return a&&a[Rf]?a.h.add(String(b),c,!0,Ia(d)?!!d.capture:!!d,e):eg(a,b,c,!0,d,e)}
function jg(a,b,c,d,e){if(Fa(b))for(var f=0;f<b.length;f++)jg(a,b[f],c,d,e);else(d=Ia(d)?!!d.capture:!!d,c=dg(c),a&&a[Rf])?a.h.remove(String(b),c,d,e):a&&(a=fg(a))&&(b=a.listeners[b.toString()],a=-1,b&&(a=Wf(b,c,d,e)),(c=-1<a?b[a]:null)&&kg(c))}
function kg(a){if("number"!==typeof a&&a&&!a.Ua){var b=a.src;if(b&&b[Rf])Xf(b.h,a);else{var c=a.type,d=a.f;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(hg(c),d):b.addListener&&b.removeListener&&b.removeListener(d);$f--;(c=fg(b))?(Xf(c,a),0==c.f&&(c.src=null,b[Yf]=null)):Uf(a)}}}
function hg(a){return a in Zf?Zf[a]:Zf[a]="on"+a}
function lg(a,b,c,d){var e=!0;if(a=fg(a))if(b=a.listeners[b.toString()])for(b=b.concat(),a=0;a<b.length;a++){var f=b[a];f&&f.capture==c&&!f.Ua&&(f=mg(f,d),e=e&&!1!==f)}return e}
function mg(a,b){var c=a.listener,d=a.yb||a.src;a.sb&&kg(a);return c.call(d,b)}
function ig(a,b){if(a.Ua)return!0;if(!Lf){var c=b||t("window.event"),d=new Pf(c,this),e=!0;if(!(0>c.keyCode||void 0!=c.returnValue)){a:{var f=!1;if(0==c.keyCode)try{c.keyCode=-1;break a}catch(l){f=!0}if(f||void 0==c.returnValue)c.returnValue=!0}c=[];for(f=d.currentTarget;f;f=f.parentNode)c.push(f);f=a.type;for(var g=c.length-1;!d.f&&0<=g;g--){d.currentTarget=c[g];var k=lg(c[g],f,!0,d);e=e&&k}for(g=0;!d.f&&g<c.length;g++)d.currentTarget=c[g],k=lg(c[g],f,!1,d),e=e&&k}return e}return mg(a,new Pf(b,this))}
function fg(a){a=a[Yf];return a instanceof Vf?a:null}
var ng="__closure_events_fn_"+(1E9*Math.random()>>>0);function dg(a){if(Ha(a))return a;a[ng]||(a[ng]=function(b){return a.handleEvent(b)});
return a[ng]}
;function og(){Hf.call(this);this.h=new Vf(this);this.ab=this;this.ra=null}
A(og,Hf);og.prototype[Rf]=!0;h=og.prototype;h.Yb=function(a){this.ra=a};
h.addEventListener=function(a,b,c,d){bg(this,a,b,c,d)};
h.removeEventListener=function(a,b,c,d){jg(this,a,b,c,d)};
h.dispatchEvent=function(a){var b=this.ra;if(b){var c=[];for(var d=1;b;b=b.ra)c.push(b),++d}b=this.ab;d=a.type||a;if("string"===typeof a)a=new Kf(a,b);else if(a instanceof Kf)a.target=a.target||b;else{var e=a;a=new Kf(d,b);Xb(a,e)}e=!0;if(c)for(var f=c.length-1;!a.f&&0<=f;f--){var g=a.currentTarget=c[f];e=pg(g,d,!0,a)&&e}a.f||(g=a.currentTarget=b,e=pg(g,d,!0,a)&&e,a.f||(e=pg(g,d,!1,a)&&e));if(c)for(f=0;!a.f&&f<c.length;f++)g=a.currentTarget=c[f],e=pg(g,d,!1,a)&&e;return e};
h.B=function(){og.H.B.call(this);if(this.h){var a=this.h,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,Uf(d[e]);delete a.listeners[c];a.f--}}this.ra=null};
function pg(a,b,c,d){b=a.h.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.Ua&&g.capture==c){var k=g.listener,l=g.yb||g.src;g.sb&&Xf(a.h,g);e=!1!==k.call(l,d)&&e}}return e&&!d.defaultPrevented}
;function qg(a,b){this.h=a;this.i=b;this.g=0;this.f=null}
qg.prototype.get=function(){if(0<this.g){this.g--;var a=this.f;this.f=a.next;a.next=null}else a=this.h();return a};function rg(a){n.setTimeout(function(){throw a;},0)}
var sg;
function tg(){var a=n.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!C("Presto")&&(a=function(){var e=ee("IFRAME");e.style.display="none";Ic(e,new hc(ic,fc(gc)));document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(wc(Ac));e.close();var g="callImmediate"+Math.random(),k="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=v(function(l){if(("*"==k||l.origin==k)&&l.data==g)this.port1.onmessage()},
this);
...
;function ug(){this.g=this.f=null}
var wg=new qg(function(){return new vg},function(a){a.reset()});
ug.prototype.add=function(a,b){var c=wg.get();c.set(a,b);this.g?this.g.next=c:this.f=c;this.g=c};
ug.prototype.remove=function(){var a=null;this.f&&(a=this.f,this.f=this.f.next,this.f||(this.g=null),a.next=null);return a};
function vg(){this.next=this.scope=this.f=null}
vg.prototype.set=function(a,b){this.f=a;this.scope=b;this.next=null};
vg.prototype.reset=function(){this.next=this.scope=this.f=null};function xg(a){yg||zg();Ag||(yg(),Ag=!0);Bg.add(a,void 0)}
var yg;function zg(){if(n.Promise&&n.Promise.resolve){var a=n.Promise.resolve(void 0);yg=function(){a.then(Cg)}}else yg=function(){var b=Cg;
!Ha(n.setImmediate)||n.Window&&n.Window.prototype&&!C("Edge")&&n.Window.prototype.setImmediate==n.setImmediate?(sg||(sg=tg()),sg(b)):n.setImmediate(b)}}
var Ag=!1,Bg=new ug;function Cg(){for(var a;a=Bg.remove();){try{a.f.call(a.scope)}catch(c){rg(c)}var b=wg;b.i(a);100>b.g&&(b.g++,a.next=b.f,b.f=a)}Ag=!1}
;function Dg(a,b){og.call(this);this.g=a||1;this.f=b||n;this.i=v(this.jf,this);this.j=y()}
A(Dg,og);h=Dg.prototype;h.enabled=!1;h.ia=null;h.setInterval=function(a){this.g=a;this.ia&&this.enabled?(this.stop(),this.start()):this.ia&&this.stop()};
...
h.B=function(){Dg.H.B.call(this);this.stop();delete this.f};
function Eg(a,b,c){if(Ha(a))c&&(a=v(a,c));else if(a&&"function"==typeof a.handleEvent)a=v(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(b)?-1:n.setTimeout(a,b||0)}
;function Fg(a,b,c){Hf.call(this);this.i=null!=c?v(a,c):a;this.h=b;this.g=v(this.Oe,this);this.f=[]}
A(Fg,Hf);h=Fg.prototype;h.Wa=!1;h.lb=0;h.Ia=null;h.Id=function(a){this.f=arguments;this.Ia||this.lb?this.Wa=!0:Gg(this)};
h.stop=function(){this.Ia&&(n.clearTimeout(this.Ia),this.Ia=null,this.Wa=!1,this.f=[])};
h.pause=function(){this.lb++};
h.resume=function(){this.lb--;this.lb||!this.Wa||this.Ia||(this.Wa=!1,Gg(this))};
h.B=function(){Fg.H.B.call(this);this.stop()};
h.Oe=function(){this.Ia=null;this.Wa&&!this.lb&&(this.Wa=!1,Gg(this))};
function Gg(a){a.Ia=Eg(a.g,a.h);a.i.apply(null,a.f)}
;function Hg(a){Hf.call(this);this.g=a;this.f={}}
A(Hg,Hf);var Ig=[];function Jg(a,b,c,d){Fa(c)||(c&&(Ig[0]=c.toString()),c=Ig);for(var e=0;e<c.length;e++){var f=bg(b,c[e],d||a.handleEvent,!1,a.g||a);if(!f)break;a.f[f.key]=f}}
function Kg(a){Jb(a.f,function(b,c){this.f.hasOwnProperty(c)&&kg(b)},a);
a.f={}}
Hg.prototype.B=function(){Hg.H.B.call(this);Kg(this)};
Hg.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented");};function Lg(a,b,c,d){this.f=a;this.h=b;this.G=c;this.C=d||1;this.j=45E3;this.i=new Hg(this);this.g=new Dg;this.g.setInterval(250)}
h=Lg.prototype;h.Ja=null;h.la=!1;h.Ya=null;h.cc=null;h.Va=null;h.Xa=null;h.wa=null;h.Ca=null;h.Ma=null;h.S=null;h.pb=0;h.ma=null;h.Ib=null;h.Ba=null;h.ib=-1;h.ed=!0;h.Fa=!1;h.Pb=0;h.Eb=null;var Mg={},Ng={};h=Lg.prototype;h.setTimeout=function(a){this.j=a};
function Og(a,b,c){a.Xa=1;a.wa=Pg(b.clone());a.Ma=c;a.l=!0;Qg(a,null)}
function Rg(a,b,c,d,e){a.Xa=1;a.wa=Pg(b.clone());a.Ma=null;a.l=c;e&&(a.ed=!1);Qg(a,d)}
function Qg(a,b){a.Va=y();Sg(a);a.Ca=a.wa.clone();Tg(a.Ca,"t",a.C);a.pb=0;a.S=a.f.Lb(a.f.nb()?b:null);0<a.Pb&&(a.Eb=new Fg(v(a.ld,a,a.S),a.Pb));Jg(a.i,a.S,"readystatechange",a.Xe);var c=a.Ja?Ub(a.Ja):{};a.Ma?(a.Ib="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.S.send(a.Ca,a.Ib,a.Ma,c)):(a.Ib="GET",a.ed&&!bd&&(c.Connection="close"),a.S.send(a.Ca,a.Ib,null,c));a.f.ja(1)}
h.Xe=function(a){a=a.target;var b=this.Eb;b&&3==Ug(a)?b.Id():this.ld(a)};
h.ld=function(a){try{if(a==this.S)a:{var b=Ug(this.S),c=this.S.l,d=this.S.getStatus();if(D&&!qd(10)||bd&&!pd("420+")){if(4>b)break a}else if(3>b||3==b&&!Yc&&!Vg(this.S))break a;this.Fa||4!=b||7==c||(8==c||0>=d?this.f.ja(3):this.f.ja(2));Wg(this);var e=this.S.getStatus();this.ib=e;var f=Vg(this.S);(this.la=200==e)?(4==b&&Xg(this),this.l?(Yg(this,b,f),Yc&&this.la&&3==b&&(Jg(this.i,this.g,"tick",this.We),this.g.start())):Zg(this,f),this.la&&!this.Fa&&(4==b?this.f.Cb(this):(this.la=!1,Sg(this)))):(400==
e&&0<f.indexOf("Unknown SID")?(this.Ba=3,G(13)):(this.Ba=0,G(14)),Xg(this),$g(this))}}catch(g){}finally{}};
function Yg(a,b,c){for(var d=!0;!a.Fa&&a.pb<c.length;){var e=ah(a,c);if(e==Ng){4==b&&(a.Ba=4,G(15),d=!1);break}else if(e==Mg){a.Ba=4;G(16);d=!1;break}else Zg(a,e)}4==b&&0==c.length&&(a.Ba=1,G(17),d=!1);a.la=a.la&&d;d||(Xg(a),$g(a))}
h.We=function(){var a=Ug(this.S),b=Vg(this.S);this.pb<b.length&&(Wg(this),Yg(this,a,b),this.la&&4!=a&&Sg(this))};
function ah(a,b){var c=a.pb,d=b.indexOf("\n",c);if(-1==d)return Ng;c=Number(b.substring(c,d));if(isNaN(c))return Mg;d+=1;if(d+c>b.length)return Ng;var e=b.substr(d,c);a.pb=d+c;return e}
function bh(a,b){a.Va=y();Sg(a);var c=b?window.location.hostname:"";a.Ca=a.wa.clone();ch(a.Ca,"DOMAIN",c);ch(a.Ca,"t",a.C);try{a.ma=new ActiveXObject("htmlfile")}catch(m){Xg(a);a.Ba=7;G(22);$g(a);return}var d="<html><body>";if(b){for(var e="",f=0;f<c.length;f++){var g=c.charAt(f);if("<"==g)e+="\\x3c";else if(">"==g)e+="\\x3e";else{var k=g;if(k in Oc)g=Oc[k];else if(k in Nc)g=Oc[k]=Nc[k];else{var l=k.charCodeAt(0);if(31<l&&127>l)g=k;else{if(256>l){if(g="\\x",16>l||256<l)g+="0"}else g="\\u",4096>l&&
...
h.Re=function(a){dh(v(this.Qe,this,a),0)};
h.Qe=function(a){this.Fa||(Wg(this),Zg(this,a),Sg(this))};
h.Zc=function(a){dh(v(this.Pe,this,a),0)};
h.Pe=function(a){this.Fa||(Xg(this),this.la=a,this.f.Cb(this),this.f.ja(4))};
h.cancel=function(){this.Fa=!0;Xg(this)};
function Sg(a){a.cc=y()+a.j;eh(a,a.j)}
function eh(a,b){if(null!=a.Ya)throw Error("WatchDog timer not null");a.Ya=dh(v(a.Se,a),b)}
function Wg(a){a.Ya&&(n.clearTimeout(a.Ya),a.Ya=null)}
h.Se=function(){this.Ya=null;var a=y();0<=a-this.cc?(2!=this.Xa&&this.f.ja(3),Xg(this),this.Ba=2,G(18),$g(this)):eh(this,this.cc-a)};
function $g(a){a.f.Bc()||a.Fa||a.f.Cb(a)}
function Xg(a){Wg(a);Jf(a.Eb);a.Eb=null;a.g.stop();Kg(a.i);if(a.S){var b=a.S;a.S=null;b.abort();b.dispose()}a.ma&&(a.ma=null)}
h.getLastError=function(){return this.Ba};
function Zg(a,b){try{a.f.Tc(a,b),a.f.ja(4)}catch(c){}}
;function fh(a){a=String(a);if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);}
function gh(a){var b=[];hh(new ih,a,b);return b.join("")}
function ih(){}
function hh(a,b,c){if(null==b)c.push("null");else{if("object"==typeof b){if(Fa(b)){var d=b;b=d.length;c.push("[");for(var e="",f=0;f<b;f++)c.push(e),hh(a,d[f],c),e=",";c.push("]");return}if(b instanceof String||b instanceof Number||b instanceof Boolean)b=b.valueOf();else{c.push("{");e="";for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(f=b[d],"function"!=typeof f&&(c.push(e),jh(d,c),c.push(":"),hh(a,f,c),e=","));c.push("}");return}}switch(typeof b){case "string":jh(b,c);break;case "number":c.push(isFinite(b)&&
!isNaN(b)?String(b):"null");break;case "boolean":c.push(String(b));break;case "function":c.push("null");break;default:throw Error("Unknown type: "+typeof b);}}}
var kh={'"':'\\"',"\\":"\\\\","/":"\\/","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\u000b"},lh=/\uffff/.test("\uffff")?/[\\"\x00-\x1f\x7f-\uffff]/g:/[\\"\x00-\x1f\x7f-\xff]/g;function jh(a,b){b.push('"',a.replace(lh,function(c){var d=kh[c];d||(d="\\u"+(c.charCodeAt(0)|65536).toString(16).substr(1),kh[c]=d);return d}),'"')}
;var mh="StopIteration"in n?n.StopIteration:{message:"StopIteration",stack:""};function nh(){}
nh.prototype.next=function(){throw mh;};
nh.prototype.sa=function(){return this};
function oh(a){if(a instanceof nh)return a;if("function"==typeof a.sa)return a.sa(!1);if(Ga(a)){var b=0,c=new nh;c.next=function(){for(;;){if(b>=a.length)throw mh;if(b in a)return a[b++];b++}};
return c}throw Error("Not implemented");}
function ph(a,b,c){if(Ga(a))try{B(a,b,c)}catch(d){if(d!==mh)throw d;}else{a=oh(a);try{for(;;)b.call(c,a.next(),void 0,a)}catch(d){if(d!==mh)throw d;}}}
function qh(a){if(Ga(a))return nb(a);a=oh(a);var b=[];ph(a,function(c){b.push(c)});
return b}
;function rh(a,b){this.g={};this.f=[];this.Da=this.h=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else if(a)if(a instanceof rh)for(c=a.oa(),d=0;d<c.length;d++)this.set(c[d],a.get(c[d]));else for(d in a)this.set(d,a[d])}
h=rh.prototype;h.ea=function(){sh(this);for(var a=[],b=0;b<this.f.length;b++)a.push(this.g[this.f[b]]);return a};
h.oa=function(){sh(this);return this.f.concat()};
h.equals=function(a,b){if(this===a)return!0;if(this.h!=a.h)return!1;var c=b||th;sh(this);for(var d,e=0;d=this.f[e];e++)if(!c(this.get(d),a.get(d)))return!1;return!0};
function th(a,b){return a===b}
h.isEmpty=function(){return 0==this.h};
h.clear=function(){this.g={};this.Da=this.h=this.f.length=0};
h.remove=function(a){return uh(this.g,a)?(delete this.g[a],this.h--,this.Da++,this.f.length>2*this.h&&sh(this),!0):!1};
function sh(a){if(a.h!=a.f.length){for(var b=0,c=0;b<a.f.length;){var d=a.f[b];uh(a.g,d)&&(a.f[c++]=d);b++}a.f.length=c}if(a.h!=a.f.length){var e={};for(c=b=0;b<a.f.length;)d=a.f[b],uh(e,d)||(a.f[c++]=d,e[d]=1),b++;a.f.length=c}}
h.get=function(a,b){return uh(this.g,a)?this.g[a]:b};
h.set=function(a,b){uh(this.g,a)||(this.h++,this.f.push(a),this.Da++);this.g[a]=b};
h.forEach=function(a,b){for(var c=this.oa(),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
h.clone=function(){return new rh(this)};
h.sa=function(a){sh(this);var b=0,c=this.Da,d=this,e=new nh;e.next=function(){if(c!=d.Da)throw Error("The map has changed since the iterator was created");if(b>=d.f.length)throw mh;var f=d.f[b++];return a?f:d.g[f]};
return e};
function uh(a,b){return Object.prototype.hasOwnProperty.call(a,b)}
;function vh(a){if(a.ea&&"function"==typeof a.ea)return a.ea();if("string"===typeof a)return a.split("");if(Ga(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return Nb(a)}
function wh(a,b,c){if(a.forEach&&"function"==typeof a.forEach)a.forEach(b,c);else if(Ga(a)||"string"===typeof a)B(a,b,c);else{if(a.oa&&"function"==typeof a.oa)var d=a.oa();else if(a.ea&&"function"==typeof a.ea)d=void 0;else if(Ga(a)||"string"===typeof a){d=[];for(var e=a.length,f=0;f<e;f++)d.push(f)}else d=Ob(a);e=vh(a);f=e.length;for(var g=0;g<f;g++)b.call(c,e[g],d&&d[g],a)}}
;function xh(a,b){this.g=this.G=this.i="";this.C=null;this.j=this.f="";this.l=!1;var c;a instanceof xh?(this.l=void 0!==b?b:a.l,yh(this,a.i),this.G=a.G,zh(this,a.g),Ah(this,a.C),this.f=a.f,Bh(this,a.h.clone()),this.j=a.j):a&&(c=Ie(String(a)))?(this.l=!!b,yh(this,c[1]||"",!0),this.G=Ch(c[2]||""),zh(this,c[3]||"",!0),Ah(this,c[4]),this.f=Ch(c[5]||"",!0),Bh(this,c[6]||"",!0),this.j=Ch(c[7]||"")):(this.l=!!b,this.h=new Dh(null,this.l))}
xh.prototype.toString=function(){var a=[],b=this.i;b&&a.push(Eh(b,Fh,!0),":");var c=this.g;if(c||"file"==b)a.push("//"),(b=this.G)&&a.push(Eh(b,Fh,!0),"@"),a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),c=this.C,null!=c&&a.push(":",String(c));if(c=this.f)this.g&&"/"!=c.charAt(0)&&a.push("/"),a.push(Eh(c,"/"==c.charAt(0)?Gh:Hh,!0));(c=this.h.toString())&&a.push("?",c);(c=this.j)&&a.push("#",Eh(c,Ih));return a.join("")};
xh.prototype.resolve=function(a){var b=this.clone(),c=!!a.i;c?yh(b,a.i):c=!!a.G;c?b.G=a.G:c=!!a.g;c?zh(b,a.g):c=null!=a.C;var d=a.f;if(c)Ah(b,a.C);else if(c=!!a.f){if("/"!=d.charAt(0))if(this.g&&!this.f)d="/"+d;else{var e=b.f.lastIndexOf("/");-1!=e&&(d=b.f.substr(0,e+1)+d)}e=d;if(".."==e||"."==e)d="";else if(-1!=e.indexOf("./")||-1!=e.indexOf("/.")){d=0==e.lastIndexOf("/",0);e=e.split("/");for(var f=[],g=0;g<e.length;){var k=e[g++];"."==k?d&&g==e.length&&f.push(""):".."==k?((1<f.length||1==f.length&&
""!=f[0])&&f.pop(),d&&g==e.length&&f.push("")):(f.push(k),d=!0)}d=f.join("/")}else d=e}c?b.f=d:c=""!==a.h.toString();c?Bh(b,a.h.clone()):c=!!a.j;c&&(b.j=a.j);return b};
xh.prototype.clone=function(){return new xh(this)};
function yh(a,b,c){a.i=c?Ch(b,!0):b;a.i&&(a.i=a.i.replace(/:$/,""))}
function zh(a,b,c){a.g=c?Ch(b,!0):b}
function Ah(a,b){if(b){b=Number(b);if(isNaN(b)||0>b)throw Error("Bad port number "+b);a.C=b}else a.C=null}
function Bh(a,b,c){b instanceof Dh?(a.h=b,Jh(a.h,a.l)):(c||(b=Eh(b,Kh)),a.h=new Dh(b,a.l))}
function ch(a,b,c){a.h.set(b,c)}
function Tg(a,b,c){Fa(c)||(c=[String(c)]);Lh(a.h,b,c)}
function Pg(a){ch(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^y()).toString(36));return a}
function Mh(a){return a instanceof xh?a.clone():new xh(a,void 0)}
function Nh(a,b,c,d){var e=new xh(null,void 0);a&&yh(e,a);b&&zh(e,b);c&&Ah(e,c);d&&(e.f=d);return e}
function Ch(a,b){return a?b?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}
function Eh(a,b,c){return"string"===typeof a?(a=encodeURI(a).replace(b,Oh),c&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}
function Oh(a){a=a.charCodeAt(0);return"%"+(a>>4&15).toString(16)+(a&15).toString(16)}
var Fh=/[#\/\?@]/g,Hh=/[#\?:]/g,Gh=/[#\?]/g,Kh=/[#\?@]/g,Ih=/#/g;function Dh(a,b){this.g=this.f=null;this.h=a||null;this.i=!!b}
function Ph(a){a.f||(a.f=new rh,a.g=0,a.h&&Ne(a.h,function(b,c){a.add(Lc(b),c)}))}
h=Dh.prototype;h.add=function(a,b){Ph(this);this.h=null;a=Qh(this,a);var c=this.f.get(a);c||this.f.set(a,c=[]);c.push(b);this.g=this.g+1;return this};
h.remove=function(a){Ph(this);a=Qh(this,a);return uh(this.f.g,a)?(this.h=null,this.g=this.g-this.f.get(a).length,this.f.remove(a)):!1};
h.clear=function(){this.f=this.h=null;this.g=0};
h.isEmpty=function(){Ph(this);return 0==this.g};
function Rh(a,b){Ph(a);b=Qh(a,b);return uh(a.f.g,b)}
h.forEach=function(a,b){Ph(this);this.f.forEach(function(c,d){B(c,function(e){a.call(b,e,d,this)},this)},this)};
h.oa=function(){Ph(this);for(var a=this.f.ea(),b=this.f.oa(),c=[],d=0;d<b.length;d++)for(var e=a[d],f=0;f<e.length;f++)c.push(b[d]);return c};
h.ea=function(a){Ph(this);var b=[];if("string"===typeof a)Rh(this,a)&&(b=mb(b,this.f.get(Qh(this,a))));else{a=this.f.ea();for(var c=0;c<a.length;c++)b=mb(b,a[c])}return b};
h.set=function(a,b){Ph(this);this.h=null;a=Qh(this,a);Rh(this,a)&&(this.g=this.g-this.f.get(a).length);this.f.set(a,[b]);this.g=this.g+1;return this};
h.get=function(a,b){if(!a)return b;var c=this.ea(a);return 0<c.length?String(c[0]):b};
function Lh(a,b,c){a.remove(b);0<c.length&&(a.h=null,a.f.set(Qh(a,b),nb(c)),a.g=a.g+c.length)}
...
h.clone=function(){var a=new Dh;a.h=this.h;this.f&&(a.f=this.f.clone(),a.g=this.g);return a};
function Qh(a,b){var c=String(b);a.i&&(c=c.toLowerCase());return c}
function Jh(a,b){b&&!a.i&&(Ph(a),a.h=null,a.f.forEach(function(c,d){var e=d.toLowerCase();d!=e&&(this.remove(d),Lh(this,e,c))},a));
a.i=b}
h.extend=function(a){for(var b=0;b<arguments.length;b++)wh(arguments[b],function(c,d){this.add(d,c)},this)};function Sh(a,b,c,d,e){if(0==d)c(!1);else{var f=e||0;d--;Th(a,b,function(g){g?c(!0):n.setTimeout(function(){Sh(a,b,c,d,f)},f)})}}
function Th(a,b,c){var d=new Image;d.onload=function(){try{Uh(d),c(!0)}catch(e){}};
d.onerror=function(){try{Uh(d),c(!1)}catch(e){}};
d.onabort=function(){try{Uh(d),c(!1)}catch(e){}};
d.ontimeout=function(){try{Uh(d),c(!1)}catch(e){}};
n.setTimeout(function(){if(d.ontimeout)d.ontimeout()},b);
Hc(d,a)}
function Uh(a){a.onload=null;a.onerror=null;a.onabort=null;a.ontimeout=null}
;function Vh(){}
Vh.prototype.stringify=function(a){return n.JSON.stringify(a,void 0)};
Vh.prototype.parse=function(a){return n.JSON.parse(a,void 0)};function Wh(a){this.f=a;this.g=new Vh}
h=Wh.prototype;h.Nb=null;h.Y=null;h.Fb=!1;h.jd=null;h.ub=null;h.Sb=null;h.Ob=null;h.fa=null;h.va=-1;h.hb=null;h.bb=null;h.connect=function(a){this.Ob=a;a=Xh(this.f,null,this.Ob);G(3);this.jd=y();var b=this.f.G;null!=b?(this.hb=b[0],(this.bb=b[1])?(this.fa=1,Yh(this)):(this.fa=2,Zh(this))):(Tg(a,"MODE","init"),this.Y=new Lg(this,void 0,void 0,void 0),this.Y.Ja=this.Nb,Rg(this.Y,a,!1,null,!0),this.fa=0)};
function Yh(a){var b=Xh(a.f,a.bb,"/mail/images/cleardot.gif");Pg(b);Sh(b.toString(),5E3,v(a.wd,a),3,2E3);a.ja(1)}
h.wd=function(a){if(a)this.fa=2,Zh(this);else{G(4);var b=this.f;b.qa=b.xa.va;$h(b,9)}a&&this.ja(2)};
function Zh(a){var b=a.f.u;if(null!=b)G(5),b?(G(11),ai(a.f,a,!1)):(G(12),ai(a.f,a,!0));else if(a.Y=new Lg(a,void 0,void 0,void 0),a.Y.Ja=a.Nb,b=a.f,b=Xh(b,b.nb()?a.hb:null,a.Ob),G(5),!D||qd(10))Tg(b,"TYPE","xmlhttp"),Rg(a.Y,b,!1,a.hb,!1);else{Tg(b,"TYPE","html");var c=a.Y;a=!!a.hb;c.Xa=3;c.wa=Pg(b.clone());bh(c,a)}}
h.Lb=function(a){return this.f.Lb(a)};
h.abort=function(){this.Y&&(this.Y.cancel(),this.Y=null);this.va=-1};
h.Bc=function(){return!1};
h.Tc=function(a,b){this.va=a.ib;if(0==this.fa)if(b){try{var c=this.g.parse(b)}catch(d){c=this.f;c.qa=this.va;$h(c,2);return}this.hb=c[0];this.bb=c[1]}else c=this.f,c.qa=this.va,$h(c,2);else if(2==this.fa)if(this.Fb)G(7),this.Sb=y();else if("11111"==b){if(G(6),this.Fb=!0,this.ub=y(),c=this.ub-this.jd,!D||qd(10)||500>c)this.va=200,this.Y.cancel(),G(12),ai(this.f,this,!0)}else G(8),this.ub=this.Sb=y(),this.Fb=!1};
h.Cb=function(){this.va=this.Y.ib;if(this.Y.la)0==this.fa?this.bb?(this.fa=1,Yh(this)):(this.fa=2,Zh(this)):2==this.fa&&((!D||qd(10)?!this.Fb:200>this.Sb-this.ub)?(G(11),ai(this.f,this,!1)):(G(12),ai(this.f,this,!0)));else{0==this.fa?G(9):2==this.fa&&G(10);var a=this.f;this.Y.getLastError();a.qa=this.va;$h(a,2)}};
h.nb=function(){return this.f.nb()};
h.isActive=function(){return this.f.isActive()};
h.ja=function(a){this.f.ja(a)};function bi(a){if(n.JSON)try{return n.JSON.parse(a)}catch(b){}return fh(a)}
;function ci(a){og.call(this);this.headers=new rh;this.L=a||null;this.g=!1;this.J=this.f=null;this.R="";this.l=0;this.i="";this.j=this.O=this.u=this.N=!1;this.F=0;this.A=null;this.ha="";this.U=this.ba=!1}
A(ci,og);var di=/^https?$/i,ei=["POST","PUT"];h=ci.prototype;
h.send=function(a,b,c,d){if(this.f)throw Error("[goog.net.XhrIo] Object is active with another request="+this.R+"; newUri="+a);b=b?b.toUpperCase():"GET";this.R=a;this.i="";this.l=0;this.N=!1;this.g=!0;this.f=this.L?Gf(this.L):Gf(Ef);this.J=this.L?this.L.getOptions():Ef.getOptions();this.f.onreadystatechange=v(this.Sc,this);try{this.getStatus(),this.O=!0,this.f.open(b,String(a),!0),this.O=!1}catch(f){this.getStatus();fi(this,f);return}a=c||"";var e=this.headers.clone();d&&wh(d,function(f,g){e.set(g,
f)});
d=fb(e.oa(),gi);c=n.FormData&&a instanceof n.FormData;!hb(ei,b)||d||c||e.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(f,g){this.f.setRequestHeader(g,f)},this);
this.ha&&(this.f.responseType=this.ha);"withCredentials"in this.f&&this.f.withCredentials!==this.ba&&(this.f.withCredentials=this.ba);try{hi(this),0<this.F&&(this.U=ii(this.f),this.getStatus(),this.U?(this.f.timeout=this.F,this.f.ontimeout=v(this.xc,this)):this.A=Eg(this.xc,this.F,this)),this.getStatus(),this.u=!0,this.f.send(a),this.u=!1}catch(f){this.getStatus(),fi(this,f)}};
function ii(a){return D&&pd(9)&&"number"===typeof a.timeout&&void 0!==a.ontimeout}
function gi(a){return"content-type"==a.toLowerCase()}
...
function fi(a,b){a.g=!1;a.f&&(a.j=!0,a.f.abort(),a.j=!1);a.i=b;a.l=5;ji(a);ki(a)}
function ji(a){a.N||(a.N=!0,a.dispatchEvent("complete"),a.dispatchEvent("error"))}
h.abort=function(a){this.f&&this.g&&(this.getStatus(),this.g=!1,this.j=!0,this.f.abort(),this.j=!1,this.l=a||7,this.dispatchEvent("complete"),this.dispatchEvent("abort"),ki(this))};
h.B=function(){this.f&&(this.g&&(this.g=!1,this.j=!0,this.f.abort(),this.j=!1),ki(this,!0));ci.H.B.call(this)};
h.Sc=function(){this.K()||(this.O||this.u||this.j?li(this):this.He())};
h.He=function(){li(this)};
function li(a){if(a.g&&"undefined"!=typeof Aa)if(a.J[1]&&4==Ug(a)&&2==a.getStatus())a.getStatus();else if(a.u&&4==Ug(a))Eg(a.Sc,0,a);else if(a.dispatchEvent("readystatechange"),4==Ug(a)){a.getStatus();a.g=!1;try{var b=a.getStatus();a:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break a;default:c=!1}var d;if(!(d=c)){var e;if(e=0===b){var f=Ie(String(a.R))[1]||null;if(!f&&n.self&&n.self.location){var g=n.self.location.protocol;f=g.substr(0,g.length-1)}e=!di.test(f?
f.toLowerCase():"")}d=e}if(d)a.dispatchEvent("complete"),a.dispatchEvent("success");else{a.l=6;try{var k=2<Ug(a)?a.f.statusText:""}catch(l){k=""}a.i=k+" ["+a.getStatus()+"]";ji(a)}}finally{ki(a)}}}
function ki(a,b){if(a.f){hi(a);var c=a.f,d=a.J[0]?u:null;a.f=null;a.J=null;b||a.dispatchEvent("ready");try{c.onreadystatechange=d}catch(e){}}}
function hi(a){a.f&&a.U&&(a.f.ontimeout=null);a.A&&(n.clearTimeout(a.A),a.A=null)}
h.isActive=function(){return!!this.f};
function Ug(a){return a.f?a.f.readyState:0}
h.getStatus=function(){try{return 2<Ug(this)?this.f.status:-1}catch(a){return-1}};
function Vg(a){try{return a.f?a.f.responseText:""}catch(b){return""}}
h.getLastError=function(){return"string"===typeof this.i?this.i:String(this.i)};function mi(a,b,c){this.f=1;this.g=[];this.i=[];this.j=new Vh;this.G=a||null;this.u=null!=b?b:null;this.l=c||!1}
function ni(a,b){this.g=a;this.f=b;this.context=null}
h=mi.prototype;h.eb=null;h.X=null;h.P=null;h.Mb=null;h.wb=null;h.ec=null;h.xb=null;h.jb=0;h.le=0;h.T=null;h.za=null;h.ta=null;h.Ha=null;h.xa=null;h.Hb=null;h.Sa=-1;h.Ec=-1;h.qa=-1;h.Qa=0;h.Oa=0;h.Ga=8;var oi=new og;function pi(a){Kf.call(this,"statevent",a)}
A(pi,Kf);function qi(a,b){Kf.call(this,"timingevent",a);this.size=b}
A(qi,Kf);function ri(a){Kf.call(this,"serverreachability",a)}
A(ri,Kf);h=mi.prototype;h.connect=function(a,b,c,d,e){G(0);this.Mb=b;this.eb=c||{};d&&void 0!==e&&(this.eb.OSID=d,this.eb.OAID=e);this.l?(dh(v(this.pc,this,a),100),si(this)):this.pc(a)};
function ti(a){ui(a);if(3==a.f){var b=a.jb++,c=a.wb.clone();ch(c,"SID",a.h);ch(c,"RID",b);ch(c,"TYPE","terminate");vi(a,c);b=new Lg(a,a.h,b,void 0);b.Xa=2;b.wa=Pg(c.clone());Hc(new Image,b.wa.toString());b.Va=y();Sg(b)}wi(a)}
h.pc=function(a){this.xa=new Wh(this);this.xa.Nb=null;this.xa.g=this.j;this.xa.connect(a)};
function si(a){a.yd(1,0);a.wb=Xh(a,null,a.Mb);xi(a)}
function ui(a){a.xa&&(a.xa.abort(),a.xa=null);a.P&&(a.P.cancel(),a.P=null);a.ta&&(n.clearTimeout(a.ta),a.ta=null);yi(a);a.X&&(a.X.cancel(),a.X=null);a.za&&(n.clearTimeout(a.za),a.za=null)}
function Ai(a,b){if(0==a.f)throw Error("Invalid operation: sending map when state is closed");a.g.push(new ni(a.le++,b));2!=a.f&&3!=a.f||xi(a)}
h.Bc=function(){return 0==this.f};
function xi(a){a.X||a.za||(a.za=dh(v(a.Xc,a),0),a.Qa=0)}
h.Xc=function(a){this.za=null;Bi(this,a)};
function Bi(a,b){if(1==a.f){if(!b){a.jb=Math.floor(1E5*Math.random());var c=a.jb++,d=new Lg(a,"",c,void 0);d.Ja=null;var e=Ci(a),f=a.wb.clone();ch(f,"RID",c);ch(f,"CVER","1");vi(a,f);Og(d,f,e);a.X=d;a.f=2}}else 3==a.f&&(b?Di(a,b):0==a.g.length||a.X||Di(a))}
function Di(a,b){if(b)if(6<a.Ga){a.g=a.i.concat(a.g);a.i.length=0;var c=a.jb-1;var d=Ci(a)}else c=b.G,d=b.Ma;else c=a.jb++,d=Ci(a);var e=a.wb.clone();ch(e,"SID",a.h);ch(e,"RID",c);ch(e,"AID",a.Sa);vi(a,e);c=new Lg(a,a.h,c,a.Qa+1);c.Ja=null;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.X=c;Og(c,e,d)}
function vi(a,b){if(a.T){var c=a.T.sc();c&&Jb(c,function(d,e){ch(b,e,d)})}}
function Ci(a){var b=Math.min(a.g.length,1E3),c=["count="+b];if(6<a.Ga&&0<b){var d=a.g[0].g;c.push("ofs="+d)}else d=0;for(var e=0;e<b;e++){var f=a.g[e].g,g=a.g[e].f;f=6>=a.Ga?e:f-d;try{Jb(g,function(k,l){c.push("req"+f+"_"+l+"="+encodeURIComponent(k))})}catch(k){c.push("req"+f+"_type="+encodeURIComponent("_badmap"))}}a.i=a.i.concat(a.g.splice(0,b));
return c.join("&")}
function Ei(a){a.P||a.ta||(a.C=1,a.ta=dh(v(a.Wc,a),0),a.Oa=0)}
function Fi(a){if(a.P||a.ta||3<=a.Oa)return!1;a.C++;a.ta=dh(v(a.Wc,a),Gi(a,a.Oa));a.Oa++;return!0}
h.Wc=function(){this.ta=null;this.P=new Lg(this,this.h,"rpc",this.C);this.P.Ja=null;this.P.Pb=0;var a=this.ec.clone();ch(a,"RID","rpc");ch(a,"SID",this.h);ch(a,"CI",this.Hb?"0":"1");ch(a,"AID",this.Sa);vi(this,a);if(!D||qd(10))ch(a,"TYPE","xmlhttp"),Rg(this.P,a,!0,this.xb,!1);else{ch(a,"TYPE","html");var b=this.P,c=!!this.xb;b.Xa=3;b.wa=Pg(a.clone());bh(b,c)}};
function ai(a,b,c){a.Hb=c;a.qa=b.va;a.l||si(a)}
h.Tc=function(a,b){if(0!=this.f&&(this.P==a||this.X==a))if(this.qa=a.ib,this.X==a&&3==this.f)if(7<this.Ga){try{var c=this.j.parse(b)}catch(f){c=null}if(Fa(c)&&3==c.length)if(0==c[0])a:{if(!this.ta){if(this.P)if(this.P.Va+3E3<this.X.Va)yi(this),this.P.cancel(),this.P=null;else break a;Fi(this);G(19)}}else this.Ec=c[1],0<this.Ec-this.Sa&&37500>c[2]&&this.Hb&&0==this.Oa&&!this.Ha&&(this.Ha=dh(v(this.me,this),6E3));else $h(this,11)}else b!=Dd.Mf.f&&$h(this,11);else if(this.P==a&&yi(this),!/^[\s\xa0]*$/.test(b)){c=
this.j.parse(b);Fa(c);for(var d=0;d<c.length;d++){var e=c[d];this.Sa=e[0];e=e[1];2==this.f?"c"==e[0]?(this.h=e[1],this.xb=e[2],e=e[3],null!=e?this.Ga=e:this.Ga=6,this.f=3,this.T&&this.T.jc(),this.ec=Xh(this,this.nb()?this.xb:null,this.Mb),Ei(this)):"stop"==e[0]&&$h(this,7):3==this.f&&("stop"==e[0]?$h(this,7):"noop"!=e[0]&&this.T&&this.T.ic(e),this.Oa=0)}}};
h.me=function(){null!=this.Ha&&(this.Ha=null,this.P.cancel(),this.P=null,Fi(this),G(20))};
function yi(a){null!=a.Ha&&(n.clearTimeout(a.Ha),a.Ha=null)}
h.Cb=function(a){if(this.P==a){yi(this);this.P=null;var b=2}else if(this.X==a)this.X=null,b=1;else return;this.qa=a.ib;if(0!=this.f)if(a.la)1==b?(b=y()-a.Va,oi.dispatchEvent(new qi(oi,a.Ma?a.Ma.length:0,b,this.Qa)),xi(this),this.i.length=0):Ei(this);else{var c=a.getLastError(),d;if(!(d=3==c||7==c||0==c&&0<this.qa)){if(d=1==b)this.X||this.za||1==this.f||2<=this.Qa?d=!1:(this.za=dh(v(this.Xc,this,a),Gi(this,this.Qa)),this.Qa++,d=!0);d=!(d||2==b&&Fi(this))}if(d)switch(c){case 1:$h(this,5);break;case 4:$h(this,
10);break;case 3:$h(this,6);break;case 7:$h(this,12);break;default:$h(this,2)}}};
function Gi(a,b){var c=5E3+Math.floor(1E4*Math.random());a.isActive()||(c*=2);return c*b}
h.yd=function(a){if(!hb(arguments,this.f))throw Error("Unexpected channel state: "+this.f);};
function $h(a,b){if(2==b||9==b){var c=null;a.T&&(c=null);var d=v(a.hf,a);c||(c=new xh("//www.google.com/images/cleardot.gif"),Pg(c));Th(c.toString(),1E4,d)}else G(2);Hi(a,b)}
h.hf=function(a){a?G(2):(G(1),Hi(this,8))};
function Hi(a,b){a.f=0;a.T&&a.T.hc(b);wi(a);ui(a)}
function wi(a){a.f=0;a.qa=-1;if(a.T)if(0==a.i.length&&0==a.g.length)a.T.Kb();else{nb(a.i);var b=nb(a.g);a.i.length=0;a.g.length=0;a.T.Kb(b)}}
function Xh(a,b,c){var d=Mh(c);if(""!=d.g)b&&zh(d,b+"."+d.g),Ah(d,d.C);else{var e=window.location;d=Nh(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.eb&&Jb(a.eb,function(f,g){ch(d,g,f)});
ch(d,"VER",a.Ga);vi(a,d);return d}
h.Lb=function(a){if(a)throw Error("Can't create secondary domain capable XhrIo object.");a=new ci;a.ba=!1;return a};
h.isActive=function(){return!!this.T&&this.T.isActive(this)};
function dh(a,b){if(!Ha(a))throw Error("Fn must not be null and must be a function");return n.setTimeout(function(){a()},b)}
h.ja=function(a){oi.dispatchEvent(new ri(oi,a))};
function G(a){oi.dispatchEvent(new pi(oi,a))}
h.nb=function(){return!(!D||qd(10))};
function Ii(){}
h=Ii.prototype;h.jc=function(){};
h.ic=function(){};
h.hc=function(){};
h.Kb=function(){};
h.sc=function(){return{}};
h.isActive=function(){return!0};function Ji(){}
Da(Ji);Ji.prototype.f=0;function Ki(a){og.call(this);this.R=a||Od();this.Ea=null;this.Ra=!1;this.f=null;this.g=void 0;this.N=this.O=this.U=null;this.Na=!1}
A(Ki,og);h=Ki.prototype;h.Wd=Ji.getInstance();h.getId=function(){return this.Ea||(this.Ea=":"+(this.Wd.f++).toString(36))};
h.na=function(){return this.f};
function Li(a,b){return a.f?F(b,a.f||a.R.f):null}
function Mi(a){a.g||(a.g=new Hg(a));return a.g}
h.Yb=function(a){if(this.U&&this.U!=a)throw Error("Method not supported");Ki.H.Yb.call(this,a)};
function Ni(a,b){if(a.Ra)throw Error("Component already rendered");if(b){a.Na=!0;var c=Qd(b);a.R&&a.R.f==c||(a.R=Od(b));a.f=b;a.ya()}else throw Error("Invalid element to decorate");}
h.ya=function(){this.Ra=!0;Oi(this,function(a){!a.Ra&&a.na()&&a.ya()})};
h.ua=function(){Oi(this,function(a){a.Ra&&a.ua()});
this.g&&Kg(this.g);this.Ra=!1};
h.B=function(){this.Ra&&this.ua();this.g&&(this.g.dispose(),delete this.g);Oi(this,function(a){a.dispose()});
!this.Na&&this.f&&ie(this.f);this.U=this.f=this.N=this.O=null;Ki.H.B.call(this)};
function Oi(a,b){a.O&&B(a.O,b,void 0)}
h.removeChild=function(a,b){if(a){var c="string"===typeof a?a:a.getId();if(this.N&&c){var d=this.N;d=(null!==d&&c in d?d[c]:void 0)||null}else d=null;a=d;if(c&&a){d=this.N;c in d&&delete d[c];jb(this.O,a);b&&(a.ua(),a.f&&ie(a.f));c=a;if(null==c)throw Error("Unable to set parent component");c.U=null;Ki.H.Yb.call(c,null)}}if(!a)throw Error("Child is not in parent component");return a};function Pi(){this.g=[];this.f=-1}
Pi.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.g[a]!=b&&(this.g[a]=b,this.f=-1)};
Pi.prototype.get=function(a){return!!this.g[a]};
function Qi(a){-1==a.f&&(a.f=cb(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
;function Ri(a,b,c){Hf.call(this);this.f=null;this.i=!1;this.l=a;this.j=c;this.g=b||window;this.h=v(this.Hd,this)}
A(Ri,Hf);h=Ri.prototype;h.start=function(){this.stop();this.i=!1;var a=Si(this),b=Ti(this);a&&!b&&this.g.mozRequestAnimationFrame?(this.f=bg(this.g,"MozBeforePaint",this.h),this.g.mozRequestAnimationFrame(null),this.i=!0):this.f=a&&b?a.call(this.g,this.h):this.g.setTimeout(tb(this.h),20)};
h.stop=function(){if(this.isActive()){var a=Si(this),b=Ti(this);a&&!b&&this.g.mozRequestAnimationFrame?kg(this.f):a&&b?b.call(this.g,this.f):this.g.clearTimeout(this.f)}this.f=null};
h.isActive=function(){return null!=this.f};
h.Hd=function(){this.i&&this.f&&kg(this.f);this.f=null;this.l.call(this.j,y())};
h.B=function(){this.stop();Ri.H.B.call(this)};
function Si(a){a=a.g;return a.requestAnimationFrame||a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame||a.msRequestAnimationFrame||null}
function Ti(a){a=a.g;return a.cancelAnimationFrame||a.cancelRequestAnimationFrame||a.webkitCancelRequestAnimationFrame||a.mozCancelRequestAnimationFrame||a.oCancelRequestAnimationFrame||a.msCancelRequestAnimationFrame||null}
;function Ui(a,b,c){Hf.call(this);this.f=a;this.i=b||0;this.g=c;this.h=v(this.wc,this)}
A(Ui,Hf);h=Ui.prototype;h.gb=0;h.B=function(){Ui.H.B.call(this);this.stop();delete this.f;delete this.g};
h.start=function(a){this.stop();this.gb=Eg(this.h,void 0!==a?a:this.i)};
h.stop=function(){this.isActive()&&n.clearTimeout(this.gb);this.gb=0};
h.isActive=function(){return 0!=this.gb};
h.wc=function(){this.gb=0;this.f&&this.f.call(this.g)};function Vi(){this.g=-1}
;function Wi(){this.g=64;this.f=[];this.l=[];this.C=[];this.i=[];this.i[0]=128;for(var a=1;a<this.g;++a)this.i[a]=0;this.j=this.h=0;this.reset()}
A(Wi,Vi);Wi.prototype.reset=function(){this.f[0]=1732584193;this.f[1]=4023233417;this.f[2]=2562383102;this.f[3]=271733878;this.f[4]=3285377520;this.j=this.h=0};
function Xi(a,b,c){c||(c=0);var d=a.C;if("string"===typeof b)for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.f[0];c=a.f[1];var g=a.f[2],k=a.f[3],l=a.f[4];for(e=0;80>e;e++){if(40>e)if(20>e){f=k^c&(g^k);var m=1518500249}else f=c^g^k,m=1859775393;else 60>e?(f=c&g|k&(c|g),m=2400959708):
...
Wi.prototype.update=function(a,b){if(null!=a){void 0===b&&(b=a.length);for(var c=b-this.g,d=0,e=this.l,f=this.h;d<b;){if(0==f)for(;d<=c;)Xi(this,a,d),d+=this.g;if("string"===typeof a)for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.g){Xi(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.g){Xi(this,e);f=0;break}}this.h=f;this.j+=b}};
Wi.prototype.digest=function(){var a=[],b=8*this.j;56>this.h?this.update(this.i,56-this.h):this.update(this.i,this.g-(this.h-56));for(var c=this.g-1;56<=c;c--)this.l[c]=b&255,b/=256;Xi(this,this.l);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.f[c]>>d&255,++b;return a};function Yi(a){return"string"==typeof a.className?a.className:a.getAttribute&&a.getAttribute("class")||""}
function Zi(a){return a.classList?a.classList:Yi(a).match(/\S+/g)||[]}
function $i(a,b){"string"==typeof a.className?a.className=b:a.setAttribute&&a.setAttribute("class",b)}
function H(a,b){return a.classList?a.classList.contains(b):hb(Zi(a),b)}
function I(a,b){if(a.classList)a.classList.add(b);else if(!H(a,b)){var c=Yi(a);$i(a,c+(0<c.length?" "+b:b))}}
function aj(a,b){if(a.classList)B(b,function(f){I(a,f)});
else{var c={};B(Zi(a),function(f){c[f]=!0});
B(b,function(f){c[f]=!0});
var d="",e;for(e in c)d+=0<d.length?" "+e:e;$i(a,d)}}
function J(a,b){a.classList?a.classList.remove(b):H(a,b)&&$i(a,ab(Zi(a),function(c){return c!=b}).join(" "))}
function bj(a,b){a.classList?B(b,function(c){J(a,c)}):$i(a,ab(Zi(a),function(c){return!hb(b,c)}).join(" "))}
function cj(a,b,c){c?I(a,b):J(a,b)}
function dj(a,b,c){H(a,b)&&(J(a,b),I(a,c))}
function ej(a,b){var c=!H(a,b);cj(a,b,c)}
;var fj=!D&&!$b();function gj(a,b){if(/-[a-z]/.test(b))return null;if(fj&&a.dataset){if(bc()&&!(b in a.dataset))return null;var c=a.dataset[b];return void 0===c?null:c}return a.getAttribute("data-"+String(b).replace(/([A-Z])/g,"-$1").toLowerCase())}
;function hj(a,b,c){for(var d=a.elements,e,f=0;e=d.item(f);f++)if(e.form==a&&!e.disabled&&"FIELDSET"!=e.tagName){var g=e.name;switch(e.type.toLowerCase()){case "file":case "submit":case "reset":case "button":break;case "select-multiple":e=ij(e);if(null!=e)for(var k,l=0;k=e[l];l++)c(b,g,k);break;default:k=ij(e),null!=k&&c(b,g,k)}}d=a.getElementsByTagName("INPUT");for(f=0;e=d[f];f++)e.form==a&&"image"==e.type.toLowerCase()&&(g=e.name,c(b,g,e.value),c(b,g+".x","0"),c(b,g+".y","0"))}
function jj(a,b,c){var d=a.get(b);d||(d=[],a.set(b,d));d.push(c)}
function kj(a,b,c){a.push(encodeURIComponent(b)+"="+encodeURIComponent(c))}
function ij(a){var b=a.type;if("string"===typeof b)switch(b.toLowerCase()){case "checkbox":case "radio":return a.checked?a.value:null;case "select-one":return b=a.selectedIndex,0<=b?a.options[b].value:null;case "select-multiple":b=[];for(var c,d=0;c=a.options[d];d++)c.selected&&b.push(c.value);return b.length?b:null}return null!=a.value?a.value:null}
;var lj=function(){if(dd){var a=/Windows NT ([0-9.]+)/;return(a=a.exec(Gb))?a[1]:"0"}return cd?(a=/10[_.][0-9_.]+/,(a=a.exec(Gb))?a[0].replace(/_/g,"."):"10"):ed?(a=/Android\s+([^\);]+)(\)|;)/,(a=a.exec(Gb))?a[1]:""):fd||gd||hd?(a=/(?:iPhone|CPU)\s+OS\s+(\S+)/,(a=a.exec(Gb))?a[1].replace(/_/g,"."):""):""}();function mj(a){return(a=a.exec(Gb))?a[1]:""}
var nj=function(){if(td)return mj(/Firefox\/([0-9.]+)/);if(D||Zc||Yc)return od;if(yd)return Tc()?mj(/CriOS\/([0-9.]+)/):mj(/Chrome\/([0-9.]+)/);if(zd&&!Tc())return mj(/Version\/([0-9.]+)/);if(ud||vd){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(Gb);if(a)return a[1]+"."+a[2]}else if(wd)return(a=mj(/Android\s+([0-9.]+)/))?a:mj(/Version\/([0-9.]+)/);return""}();function oj(a,b,c,d,e,f,g){var k;if(k=c.offsetParent){var l="HTML"==k.tagName||"BODY"==k.tagName;if(!l||"static"!=df(k,"position")){var m=hf(k);if(!l){l=pf(k);var p;if(p=l){if(p=zd)p=0<=Eb(nj,10);var q;if(q=id)q=0<=Eb(lj,10);p=ad||p||q}l=p?-k.scrollLeft:!l||$c&&pd("8")||"visible"==df(k,"overflowX")?k.scrollLeft:k.scrollWidth-k.clientWidth-k.scrollLeft;m=Md(m,new Ld(l,k.scrollTop))}}}k=m||new Ld;m=of(a);if(l=gf(a)){var x=new Ze(l.left,l.top,l.right-l.left,l.bottom-l.top);l=Math.max(m.left,x.left);
...
;function K(a){Hf.call(this);this.j=1;this.h=[];this.i=0;this.f=[];this.g={};this.l=!!a}
A(K,Hf);h=K.prototype;h.subscribe=function(a,b,c){var d=this.g[a];d||(d=this.g[a]=[]);var e=this.j;this.f[e]=a;this.f[e+1]=b;this.f[e+2]=c;this.j=e+3;d.push(e);return e};
...
function sj(a,b,c){xg(function(){a.apply(b,c)})}
...
uj.prototype.set=function(a,b){void 0===b?this.f.remove(a):this.f.set(a,gh(b))};
...
A(Aj,yj);function Bj(a,b){var c=[];ph(b,function(d){try{var e=Aj.prototype.g.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):zj(e)&&c.push(d)},a);
return c}
function Cj(a,b){var c=Bj(a,b);B(c,function(d){Aj.prototype.remove.call(this,d)},a)}
;function Dj(){}
;function Ej(){}
A(Ej,Dj);Ej.prototype.clear=function(){var a=qh(this.sa(!0)),b=this;B(a,function(c){b.remove(c)})};function Fj(a){this.f=a}
...
h.sa=function(a){var b=0,c=this.f,d=new nh;d.next=function(){if(b>=c.length)throw mh;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
A(Hj,Fj);function Ij(a,b){this.g=a;this.f=null;if(D&&!qd(9)){Jj||(Jj=new rh);this.f=Jj.get(a);this.f||(b?this.f=document.getElementById(b):(this.f=document.createElement("userdata"),this.f.addBehavior("#default#userData"),document.body.appendChild(this.f)),Jj.set(a,this.f));try{this.f.load(this.g)}catch(c){this.f=null}}}
...
h.sa=function(a){var b=0,c=this.f.XMLDocument.documentElement.attributes,d=new nh;d.next=function(){if(b>=c.length)throw mh;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
Nj.prototype.sa=function(a){var b=this.g.sa(!0),c=this,d=new nh;d.next=function(){for(var e=b.next();e.substr(0,c.f.length)!=c.f;)e=b.next();return a?e.substr(c.f.length):c.g.get(e)};
...
function lk(a,b){"disabled"in a&&(a.disabled=!b);1==a.nodeType&&cj(a,"disabled",!b);if(a.hasChildNodes())for(var c=0,d;d=a.childNodes[c];++c)d instanceof Element&&lk(d,b)}
...
function nk(){cj(document.body,"hide-players",!1);B(Sd("preserve-players"),function(a){J(a,"preserve-players")})}
...
uk.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Qb=t("ytEventsEventsListeners")||{};z("ytEventsEventsListeners",Qb);var vk=t("ytEventsEventsCounter")||{count:0};z("ytEventsEventsCounter",vk);
function wk(a,b,c,d){d=void 0===d?{}:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Pb(function(e){var f="boolean"===typeof e[4]&&e[4]==!!d,g=Ia(e[4])&&Ia(d)&&Tb(e[4],d);return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&(f||g)})}
...
g=qk(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),xk()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);Qb[e]=[a,b,c,g,d];return e}
...
function zk(a){a&&("string"==typeof a&&(a=[a]),B(a,function(b){if(b in Qb){var c=Qb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?xk()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Qb[b]}}))}
function Ak(a){a=a||window.event;a=a.target||a.srcElement;3==a.nodeType&&(a=a.parentNode);return a}
var xk=ub(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function Bk(a,b,c,d){return yk(a,b,c,function(e){return H(e,d)})}
...
function Pk(a){var b=[];Jb(a,function(c,d){var e=encodeURIComponent(String(d)),f;Fa(c)?f=c:f=[c];B(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
...
function Wk(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(m){}try{var e=b.outerWidth;var f=b.outerHeight}catch(m){}try{var g=b.innerWidth;var k=b.innerHeight}catch(m){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,g,k];c=a.f.top;try{var l=Wd(c||window).round()}catch(m){l=new Nd(-12245933,-12245933)}c=l;l={};d=new Pi;n.SVGElement&&n.document.createElementNS&&d.set(0);e=Xe();e["allow-top-navigation-by-user-activation"]&&d.set(1);e["allow-popups-to-escape-sandbox"]&&
d.set(2);n.crypto&&n.crypto.subtle&&d.set(3);n.TextDecoder&&n.TextEncoder&&d.set(4);d=Qi(d);l.bc=d;l.bih=c.height;l.biw=c.width;l.brdim=b.join();a=a.g;return l.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,l.wgl=!!Cd.WebGLRenderingContext,l}
...
return l}
;var nl={},ol=0;function pl(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Gb,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a=oc(sc(a)),"about:invalid#zClosurez"===a?a="":(a=wc(xc(a)).toString(),a=encodeURIComponent(String(gh(a)))),/^[\s\xa0]*$/.test(a)||(a=ae("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),Qd(a).body.appendChild(a))):e?il(a,b,"POST",e,d):M("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?il(a,b,"GET","",d):ql(a,b)||rl(a,b))}
...
;function ul(a,b){(a=E(a))&&a.style&&(a.style.display=b?"":"none",cj(a,"hid",!b))}
function vl(a){return(a=E(a))?"none"!=a.style.display&&!H(a,"hid"):!1}
function wl(a){if(a=E(a))vl(a)?(a.style.display="none",I(a,"hid")):(a.style.display="",J(a,"hid"))}
...
;var Nl={},Ol="ontouchstart"in document;function Pl(a,b,c){switch(a){case "mouseover":case "mouseout":var d=3;break;case "mouseenter":case "mouseleave":d=9}return Ce(c,function(e){return H(e,b)},d)}
...
var lm=t("ytLoggingTransportDispatchedStats_")||{};z("ytLoggingTransportDispatchedStats_",lm);z("ytytLoggingTransportCapturedTime_",t("ytLoggingTransportCapturedTime_")||{});function mm(){Q(fm);Q(gm);gm=0;if(!Rb(jm)){for(var a in jm){var b=em[a];b&&b.isReady()&&(nm(a,b),delete jm[a],im=!1)}Rb(jm)||om()}}
...
function nm(a,b){var c=bm[a],d=lm[a]||{};lm[a]=d;var e=Math.round(Xl());for(q in jm[a]){var f=Vb,g=b.f||qm();g={client:{hl:g.be,gl:g.ae,clientName:g.Zd,clientVersion:g.innertubeContextClientVersion,configInfo:g.Yd}};var k=window.devicePixelRatio;k&&1!=k&&(g.client.screenDensityFloat=String(k));k=M("EXPERIMENTS_TOKEN","");""!==k&&(g.client.experimentsToken=k);var l=k=void 0,m=[],p=M("EXPERIMENTS_FORCED_FLAGS",{});for(l in p)m.push({key:l,value:String(p[l])});l=M("EXPERIMENT_FLAGS",{});for(k in l)k.startsWith("force_")&&
...
ym.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,y()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(gh(b))}catch(f){return}else e=escape(b);Yj(a,e,c,"/",this.g)};
...
function Cm(a){var b=zm.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(Xl())-d.requestTime)){var e=d.authState,f=xm(wm(!1));Tb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(Xl())),rm(a,d.method,e,{}));delete b[c]}}zm.set("requests",b,86400,!0)}}
...
h.Rd=function(){var a=this.g;if(0!=Lb(a))for(var b in a){var c=a[b],d=De(c.activeButtonNode||c.parentNode,V(this));if(void 0==d||void 0==c)break;Sm(this,d,c,!0)}};
function Rm(a,b,c,d,e){var f=vl(c),g=9==d.keyCode;g||32==d.keyCode||13==d.keyCode?(d=Tm(a,c))?(b=le(d),"a"==b.tagName.toLowerCase()?Mm(b.href):Ck(b)):g&&Um(a,b):f?27==d.keyCode?(Tm(a,c),Um(a,b)):e(b,c,d):(a=H(b,V(a,"reverse"))?38:40,d.keyCode==a&&(Ck(b),d.preventDefault()))}
h.Dc=function(a,b,c){c.altKey||c.ctrlKey||c.shiftKey||c.metaKey||(a=Qm(this,a),vl(a)&&c.preventDefault())};
function Tm(a,b){var c=V(a,"menu-item-highlight"),d=F(c,b);d&&J(d,c);return d}
function Vm(a,b,c){I(c,V(a,"menu-item-highlight"));var d=c.getAttribute("id");d||(d=V(a,"item-id-"+Ja(c)),c.setAttribute("id",d));b.setAttribute("aria-activedescendant",d)}
...
function Xm(a,b){var c=b.iframeMask;c||(c=ee("IFRAME"),c.src='javascript:""',$i(c,V(a,"menu-mask")),yl(c),b.iframeMask=c);return c}
function Sm(a,b,c,d){var e=De(b,V(a,"group")),f=!!a.I(b,"button-menu-ignore-group");e=e&&!f?e:b;f=9;var g=8,k=of(b);if(H(b,V(a,"reverse"))){f=8;g=9;k=k.top+"px";try{c.style.maxHeight=k}catch(p){}}H(b,"flip")&&(H(b,V(a,"reverse"))?(f=12,g=13):(f=13,g=12));var l;a.I(b,"button-has-sibling-menu")?l=ff(e):a.I(b,"button-menu-root-container")&&(l=Ym(a,b));D&&!pd("8")&&(l=null);if(l){var m=of(l);m=new Ye(-m.top,m.left,m.top,-m.left)}l=new Ld(0,1);H(b,V(a,"center-menu"))&&(l.x-=Math.round((mf(c).width-mf(b).width)/
...
this.cb(a,"button-menu-action",!0);I(a,V(this,"active"));b=v(this.qd,this,a,!1);d=v(this.qd,this,a,!0);c=v(this.kf,this,a,void 0);this.f&&Qm(this,this.f)==Qm(this,a)||Pm(this);U("yt-uix-button-menu-show",a);zk(this.h);this.h=[O(document,"click",d),O(document,"contextmenu",b),O(window,"resize",c)];this.f=a}}};
...
var f=[V(a,"active")];e&&f.push(V(a,"group-active"));bj(b,f);U("yt-uix-button-menu-hide",b);zk(a.h);a.h.length=0}}
h.kf=function(a,b){var c=Qm(this,a);if(c){b&&(b instanceof uc?Fc(c,b):re(c,b));var d=!!this.I(a,"button-menu-fixed");Sm(this,a,c,d)}};
h.qd=function(a,b,c){c=Ak(c);var d=De(c,V(this));if(d){d=Qm(this,d);var e=Qm(this,a);if(d==e)return}d=De(c,V(this,"menu"));e=d==Qm(this,a);var f=H(c,V(this,"menu-item")),g=H(c,V(this,"menu-close"));if(!d||e&&(f||g))Um(this,a),d&&b&&this.I(a,"button-menu-indicate-selected")&&((a=F(V(this,"content"),a))&&re(a,ze(c)),Zm(this,d,c))};
function Zm(a,b,c){var d=V(a,"menu-item-selected");B(Sd(d,b),function(e){J(e,d)});
I(c.parentNode,d)}
function Qm(a,b){if(!b.widgetMenu){var c=a.I(b,"button-menu-id");c=c&&E(c);var d=V(a,"menu");c?aj(c,[d,V(a,"menu-external")]):c=F(d,b);b.widgetMenu=c}return b.widgetMenu}
h.isToggled=function(a){return H(a,V(this,"toggled"))};
h.toggle=function(a){if(this.I(a,"button-toggle")){var b=De(a,V(this,"group")),c=V(this,"toggled"),d=H(a,c);if(b&&this.I(b,"button-toggle-group")){var e=this.I(b,"button-toggle-group");B(Sd(V(this),b),function(f){f!=a||"optional"==e&&d?(J(f,c),f.removeAttribute("aria-pressed")):(I(a,c),f.setAttribute("aria-pressed","true"))})}else d?a.removeAttribute("aria-pressed"):a.setAttribute("aria-pressed","true"),ej(a,c)}};
...
h.show=function(a){var b=this.ca(a);if(b){I(b,V(this,"active"));var c=bn(this,a,b);if(c){c.cardTargetNode=a;c.cardRootNode=b;cn(this,a,c);var d=V(this,"card-visible"),e=this.I(a,"card-delegate-show")&&this.I(b,"card-action");this.cb(b,"card-action",a);this.h=a;yl(c);P(v(function(){e||(xl(c),U("yt-uix-card-show",b,a,c));dn(c);I(c,d);U("yt-uix-kbd-nav-move-in-to",c)},this),10)}}};
function bn(a,b,c){var d=c||b,e=V(a,"card");c=en(a,d);var f=E(V(a,"card")+gk(d));if(f)return a=F(V(a,"card-body"),f),qe(a,c)||(ie(c),a.appendChild(c)),f;f=document.createElement("div");f.id=V(a,"card")+gk(d);$i(f,e);(d=a.I(d,"card-class"))&&aj(f,d.split(/\s+/));d=document.createElement("div");d.className=V(a,"card-border");b=a.I(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var g=document.createElement("div");g.className=
...
f=Math.min(f,(d?R.height:R.width)-24-6);6>f&&(f=6,d?r.y+=12-b.offsetHeight/2:r.x+=12-b.offsetWidth/2);R=null;g||(R=10);b=V(a,"card-flip");a=V(a,"card-reverse");cj(c,b,m);cj(c,a,l);R=oj(e,p,c,q,r,null,R);!g&&R&&(R&48&&(m=!m,p^=4,q^=4),R&192&&(l=!l,p^=1,q^=1),cj(c,b,m),cj(c,a,l),oj(e,p,c,q,r));k&&(e=parseInt(c.style.top,10),g=Yd(document).y,$e(c,"position","fixed"),$e(c,"top",e-g+"px"));x&&(c.style.right="",e=of(c),e.left=e.left||parseInt(c.style.left,10),g=Wd(window),c.style.left="",c.style.right=
...
h.hide=function(a){if(a=this.ca(a)){var b=E(V(this,"card")+gk(a));b&&(J(a,V(this,"active")),J(b,V(this,"card-visible")),yl(b),this.h=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(ie(b.cardMask),b.cardMask=null))}};
function an(a){a.h&&a.hide(a.h)}
h.kd=function(a,b){var c=this.ca(a);if(c){if(b){var d=en(this,c);if(!d)return;b instanceof uc?Fc(d,b):re(d,b)}H(c,V(this,"active"))&&(c=bn(this,a,c),cn(this,a,c),xl(c),dn(c))}};
h.isActive=function(a){return(a=this.ca(a))?H(a,V(this,"active")):!1};
function en(a,b){var c=b.cardContentNode;if(!c){var d=V(a,"content"),e=V(a,"card-content");(c=(c=a.I(b,"card-id"))?E(c):F(d,b))||(c=document.createElement("div"));var f=c;J(f,d);I(f,e);b.cardContentNode=c}return c}
function dn(a){var b=a.cardMask;b||(b=ee("IFRAME"),b.src='javascript:""',aj(b,["yt-uix-card-iframe-mask"]),a.cardMask=b);b.style.position=a.style.position;b.style.top=a.style.top;b.style.left=a.offsetLeft+"px";b.style.height=a.clientHeight+"px";b.style.width=a.clientWidth+"px";document.body.appendChild(b)}
...
h.zc=function(a,b,c){var d=c.keyCode;if(a=De(a,V(this)))switch(d){case 13:case 32:this.Mc(a);break;case 27:c.preventDefault();c.stopImmediatePropagation();a:{for(c=gj(a,"kbdNavMoveOut");!c;){c=De(a.parentElement,V(this));if(!c)break a;c=gj(c,"kbdNavMoveOut")}c=E(c);this.vb(c);U("yt-uix-kbd-nav-move-out-done",c)}break;case 40:case 38:if((b=c.target)&&H(a,V(this,"list")))switch(d){case 40:this.Nc(b,a);break;case 38:d=document.activeElement==a,a=hn(a),b=a.indexOf(b),0>b&&!d||(b=d?a.length-1:(a.length+
b-1)%a.length,a[b].focus(),jn(this,a[b]))}c.preventDefault()}};
h.Mc=function(a){var b=gj(a,"kbdNavMoveIn");b=E(b);kn(this,a,b);this.vb(b)};
...
function kn(a,b,c){if(b&&c)if(I(c,V(a)),a=b.id,a||(a="kbd-nav-"+Math.floor(1E6*Math.random()+1),b.id=a),b=a,fj&&c.dataset)c.dataset.kbdNavMoveOut=b;else{if(/-[a-z]/.test("kbdNavMoveOut"))throw Error("");c.setAttribute("data-"+"kbdNavMoveOut".replace(/([A-Z])/g,"-$1").toLowerCase(),b)}}
h.Nc=function(a,b){var c=document.activeElement==b,d=hn(b),e=d.indexOf(a);0>e&&!c||(c=c?0:(e+1)%d.length,d[c].focus(),jn(this,d[c]))};
function jn(a,b){if(b){var c=Be(b,"LI");c&&(I(c,V(a,"highlight")),gn=O(b,"blur",v(function(d){J(d,V(this,"highlight"));zk(gn)},a,c)))}}
...
A(ln,Rl);Da(ln);function mn(a){var b=ln.getInstance();if(H(a,V(b)))return a;var c=b.ca(a);return c?c:De(a,V(b,"content"))==b.f?b.g:null}
...
this.i=new K};
h.unregister=function(){Ul(this,"click",this.yc);this.g=this.f=null;zk(sb(Nb(this.h)));this.h={};Jb(this.l,function(a){ie(a)},this);
this.l={};Jf(this.i);this.i=null;ln.H.unregister.call(this)};
h.yc=function(a,b,c){a&&(b=on(this,a),!b.disabled&&jk(c.target,b)&&pn(this,a))};
h.Od=function(a,b,c){a&&H(a,V(this,"hover"))&&jk(c.target,on(this,a))&&pn(this,a,!0)};
h.wf=function(){this.f&&this.g&&qn(this,this.g,this.f)};
function qn(a,b,c){var d=rn(a,b);if(d){var e=mf(c);if(e instanceof Nd){var f=e.height;e=e.width}else throw Error("missing height argument");d.style.width=lf(e,!0);d.style.height=lf(f,!0)}c==a.f&&(e=9,f=8,H(b,V(a,"reversed"))&&(e^=1,f^=1),H(b,V(a,"flipped"))&&(e^=4,f^=4),a=new Ld(0,1),d&&oj(b,e,d,f,a,null,197),oj(b,e,c,f,a,null,197))}
function pn(a,b,c){sn(a,b)&&!c?nn(a,b):(tn(a,b),!a.f||jk(b,a.f)?a.sd(b):qj(a.i,v(a.sd,a,b)))}
h.sd=function(a){if(a){var b=un(this,a);if(b){Lk("yt-uix-menu-before-show",a,b);this.f?jk(a,this.f)||nn(this,this.g):(this.g=a,this.f=b,H(a,V(this,"sibling-content"))||(ie(b),document.body.appendChild(b)),b.style.minWidth=on(this,a).offsetWidth-2+"px");var c=rn(this,a);c&&b.parentNode&&b.parentNode.insertBefore(c,b.nextSibling);J(b,V(this,"content-hidden"));qn(this,a,b);aj(on(this,a),[V(this,"trigger-selected"),"yt-uix-button-toggled"]);U("yt-uix-menu-show",a);vn(b);wn(this,a);U("yt-uix-kbd-nav-move-in-to",
b);var d=v(this.xf,this,a),e=v(this.fe,this,a);c=Ja(a).toString();this.h[c]=[O(b,"click",e),O(document,"click",d)];H(a,V(this,"indicate-selected"))&&(d=v(this.ge,this,a),this.h[c].push(O(b,"click",d)));H(a,V(this,"hover"))&&(a=v(this.Pd,this,a),this.h[c].push(O(document,"mousemove",a)))}}};
...
function yn(a,b){if(b){var c=un(a,b);bj(on(a,b),[V(a,"trigger-selected"),"yt-uix-button-toggled"]);I(c,V(a,"content-hidden"));var d=un(a,b);d&&Ud(d,{"aria-expanded":"false"});(d=rn(a,b))&&d.parentNode&&ie(d);c&&c==a.f&&(a.g.appendChild(c),a.f=null,a.g=null,a.i&&a.i.Z("ROOT_MENU_REMOVED"));U("yt-uix-menu-hide",b);c=Ja(b).toString();zk(a.h[c]);delete a.h[c]}}
...
function zn(a,b,c){var d=un(a,b);d&&H(b,V(a,"checked"))&&(a=Be(c,"LI"))&&(a=F("yt-ui-menu-item-checked-hid",a))&&(B(Sd("yt-ui-menu-item-checked",d),function(e){dj(e,"yt-ui-menu-item-checked","yt-ui-menu-item-checked-hid")}),dj(a,"yt-ui-menu-item-checked-hid","yt-ui-menu-item-checked"))}
function sn(a,b){var c=un(a,b);return c?!H(c,V(a,"content-hidden")):!1}
function vn(a){B(Td(document,"UL",null,a),function(b){b.tabIndex=0;var c=fn.getInstance();aj(b,[V(c),V(c,"list")])})}
function un(a,b){var c=N(b,"menu-content-id");return c&&(c=E(c))?(aj(c,[V(a,"content"),V(a,"content-external")]),c):b==a.g?a.f:F(V(a,"content"),b)}
function rn(a,b){var c=Ja(b).toString(),d=a.l[c];if(!d){d=ee("IFRAME");d.src='javascript:""';var e=[V(a,"mask")];B(Zi(b),function(f){e.push(f+"-mask")});
aj(d,e);a.l[c]=d}return d||null}
...
h.nc=function(a,b,c){c.preventDefault();b=Be(c.target,"button");if(!b||!b.disabled){b=this.I(a,"card-target");var d;b?d=Rd(document,b):d=a;a=d;d=this.ca(a);this.I(d,"disabled")||(H(d,V(this,"active"))?(this.hide(a),J(d,V(this,"active"))):(this.show(a),I(d,V(this,"active"))))}};
...
this.l=this.j=null}
var Fn={LOADING:"loading",Lf:"content",Wf:"working"};function En(a){a=F("yt-dialog-fg-content",a.f);var b=[];Jb(Fn,function(c){b.push("yt-dialog-show-"+c)});
bj(a,b);I(a,"yt-dialog-show-content")}
h=Dn.prototype;
h.show=function(){if(!this.K()){this.C=document.activeElement;if(!this.L){this.g||(this.g=E("yt-dialog-bg"),this.g||(this.g=ee("div"),this.g.id="yt-dialog-bg",$i(this.g,"yt-dialog-bg"),document.body.appendChild(this.g)));var a=window,b=a.document;var c=0;if(b){c=b.body;var d=b.documentElement;if(d&&c)if(a=Wd(a).height,Xd(b)&&d.scrollHeight)c=d.scrollHeight!=a?d.scrollHeight:d.offsetHeight;else{b=d.scrollHeight;var e=d.offsetHeight;d.clientHeight!=e&&(b=c.scrollHeight,e=c.offsetHeight);c=b>a?b>e?b:
e:b<e?b:e}else c=0}this.g.style.height=c+"px";xl(this.g)}this.Ac();c=Gn(this);Hn(c);this.j=O(document,"keydown",v(this.ee,this));this.ac(this.f);this.N&&(this.l=O(document,"click",v(this.Ue,this)));xl(this.f);this.h.setAttribute("tabindex","0");In(this);this.u||I(document.body,"yt-dialog-active");Pm(Om.getInstance());an(An.getInstance());an(Bn.getInstance());U("yt-ui-dialog-show-complete",this)}};
function Jn(){return db(Sd("yt-dialog"),function(a){return vl(a)})}
h.Ac=function(){if(!this.O){var a=this.f;cj(document.body,"hide-players",!0);a&&cj(a,"preserve-players",!0)}};
...
z("yt.ui.Dialog",Dn);function Ln(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||Ub(b);this.assets=a.assets||{};this.attrs=a.attrs||Ub(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Ln.prototype.clone=function(){var a=new Ln,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ea(c)?a[b]=Ub(c):a[b]=c}return a};var Mn=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Nn=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function On(a,b){var c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(Mn,""),c=c.replace(Nn,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else Pn(a,b,c)}
...
var Rn={};function Un(){Hf.call(this);this.f=[]}
ka(Un,Hf);Un.prototype.B=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.cg)}Hf.prototype.B.call(this)};var Vn=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Wn(a,b){a=a||"";if(window.spf){var c=a.match(Vn);spf.style.load(a,c?c[1]:"",b);return null}return Xn(a,b)}
...
h.B=function(){lo(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){rk(b)}this.Ea=null;for(var a in this.i)n[this.i[a]]=null;this.ab=this.f=this.api=null;delete this.ha;delete this.l;Hf.prototype.B.call(this)};
...
;function to(){cj(E("page-container"),"remote-connected",!!W)}
;var uo=!1;function vo(a){cj(E("player-mole-container"),"watch-mole",a);a=E("player-mole-container");var b=E("player");uo=!b||H(b,"off-screen")||!a||H(a,"watch-mole");(a=so())&&a.isReady()&&a.setMinimized(uo)}
...
ka(xo,Error);function yo(a){var b=t("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,!1,void 0):(b=Sj(),b.push([a,"ERROR",void 0,void 0,!1,void 0]),Rj("ERRORS",b))}
function zo(a){var b=t("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,!1,void 0):(b=Sj(),b.push([a,"WARNING",void 0,void 0,!1,void 0]),Rj("ERRORS",b))}
...
v(Bo.clearResourceTimings||Bo.webkitClearResourceTimings||Bo.mozClearResourceTimings||Bo.msClearResourceTimings||Bo.oClearResourceTimings||u,Bo);new Ui(hp,1E3);function hp(){gp("vptl");gp("vpl")}
...
T.Td=function(){J(document.body,"sitewide-consent-visible");Yj("HideTicker","true",86400,"/");tl(Pe({a:"consent",consent:"later"}))};
...
;function rp(a){Ki.call(this,a);this.qb=[];this.ha=[]}
A(rp,Ki);rp.prototype.ua=function(){B(this.qb,zk);Kk(this.ha);rp.H.ua.call(this)};function sp(){rp.call(this);this.l=this.i=this.j=null;this.A="horizontal";this.u=null}
ka(sp,rp);sp.prototype.ya=function(){rp.prototype.ya.call(this);this.A=N(this.na(),"overflowable-list-orientation")||"horizontal";this.j=Li(this,"parent-list");this.u=Li(this,"overflow-container");this.i=Li(this,"overflow-list");this.l=Li(this,"overflowable-list-more-button")};
function tp(){var a=[];B(Sd("overflowable-list-root",up),function(b){var c=new sp;Ni(c,b);a.push(c)});
return a}
...
function Op(a,b){var c=b||!1,d=H(Mp,"show-guide");cj(Mp,"show-guide",a);Np&&Np.setAttribute("aria-expanded",a);a&&!H(document.documentElement,"no-focus-outline")&&c?(c=F("guide-item",E("guide-container")))&&c.focus():U("guide-hidden");if(a&&!d||!a&&d){d="";if(c=E("page"))d=c.className;d=Pe({"module-id":"guide-main",expanded:!0,auto:!1,"page-class":d,notification:!1});tl("a=guide-toggled"+(d?"&"+d:""),void 0)}(d=E("page"))&&zd&&(c=d.style.width,d.style.width="99.99%",Uc(d.offsetWidth),d.style.width=
c)}
function Pp(){return H(Mp,"show-guide")}
function Qp(){return H(document.body,"guide-pinning-enabled")}
function Rp(){return Qp()&&H(Mp,"guide-pinned")}
...
function hq(a,b,c){gq(b,!!a)||(b=fq(b),I(b,"guide-item-removal-notification"),a.appendChild(b),P(w(I,a,"removing-guide-item"),0),P(function(){ie(a);U(c)},2E3))}
function gq(a,b,c){if(b&&Pp())return!1;ge(Wp);Wp.appendChild(fq(a,c));I(document.body,"show-guide-button-notification");P(w(J,document.body,"show-guide-button-notification"),2E3);return!0}
...
var jq=ub(function(){var a=new Gj;return a.isAvailable()?new Aj(a):null}),kq=ub(function(){var a=new Hj;
return a.isAvailable()?new Aj(a):null});var oq=[];function pq(a){for(var b=0;b<a.length;b++){var c=a[b];if(H(c,"generic-promo-impression-logging")){for(var d=Sd("generic-promo-impression-feedback",c),e=0;e<d.length;e++){var f={feedback_tokens:[N(d[e],"feedback-token")]};hl("/feed_change_ajax?action_give_feedback=1",{method:"POST",ka:f})}J(c,"generic-promo-impression-logging")}}}
;var qq=[];
function rq(){B(Sd("promoted-button-container"),function(a){a:{var b=N(a,"promo-id");var c=parseInt(N(a,"promo-impression-cap"),10)||0;var d=parseInt(N(a,"promo-impression-delay"),10)||0;if(b&&0<c&&0<d){b="yt-hint-"+b;var e=lq(b)||{},f=e.lastSeen;e=e.impressions||0;if(f&&y()-new Date(f)<1E3*d||e>=c){c=!1;break a}e={lastSeen:y(),impressions:e+1};iq(b,e,2592E3)}c=!0}if(c){if("true"===N(a,"promo-visible")&&(c=An.getInstance(),c.kd(a),"hidden"!=window.getComputedStyle(a).visibility&&(c.show(a),H(a,"hide-hint-on-scroll")&&
(c=E(N(a,"scroll-parent"))||window,qq.push(Dk(c,"scroll",v(sq,this,a)))))),a&&(c=t("yt.www.page.visibilitymonitor.delegateByClass")))a=c(a,t("yt.www.page.visibilitymonitor.States.VISIBLE"),pq,"generic-promo-impression-logging"),oq.push(a)}else(a=F("generic-promo-impression-logging",a))&&J(a,"generic-promo-impression-logging")})}
...
function Fq(){up=E("guide");Gp=E("guide-channels");Hp=E("appbar-guide-menu");Ip=E("appbar-guide-iframe-mask");Zp();up&&(Lp(),H(document.body,"exp-scrollable-guide")||Gq(),Cq.push(Bk(up,"click",Hq,"guide-sort-choice")),H(document.body,"exp-scrollable-guide")?(Iq(Aq(!0)),Dq.push(S("page-resize",Iq))):Dq.push(S("page-resize",Jq)),Dq.push(S("guide-channel-section-updated",Kq)),Dq.push(S("guide-playlist-section-updated",w(Jq,w(Aq,!0)))),Dq.push(S("force-reload-subscriptions",Lq)),Dq.push(S("update-guide-subscriptions",
...
function Qq(a){var b=F("guide-flyout-trigger",a),c=F("guide-flyout-iframe-mask",a);J(F("guide-flyout",a),"flyout-shown");c&&J(c,"flyout-shown");J(b,"on-hover")}
...
p+"px");"rtl"==document.body.getAttribute("dir")?(e.style.right=k+"px",e.style.left="",m&&(m.style.right=k+"px",m.style.left="")):(e.style.left=g+"px",e.style.right="",m&&(m.style.left=g+"px",m.style.right=""));I(b,"flyout-shown");d&&I(d,"flyout-shown");I(c,"on-hover");U("yt-dom-content-change",a)}
...
function Mq(a){var b=a.channels;b&&(a=E("guide-subscriptions-section"),b=fe(Ee(b)),je(b,a),Eq=tp(),Tq(),B(Sd("yt-uix-tooltip-tip-visible"),function(c){J(c,"yt-uix-tooltip-tip-visible")}))}
...
function Jq(a){if(Eq&&!H(document.body,"exp-scrollable-guide")){var b=Vq(a),c=Eq.length,d=0;Eq.sort(vp||rb);B(Eq,function(e,f){var g=wp(e)-d;g=Math.min(g,b/(c-f));b-=(c-f)*g;g=d+=g;g-=g>=wp(e)?0:e.l?yp(e,e.l):0;g=Math.max(zp(e),g);var k=xp(e,e.j);if(k>g)for(;k>g;){var l=e.j;if(l=void 0!==l.lastElementChild?l.lastElementChild:me(l.lastChild,!1)){var m=yp(e,l);k-=m;he(e.i,l)}else break}else if(k<g){for(l=document.createDocumentFragment();0!=ke(e.i).length;)if(m=le(e.i)){var p=yp(e,m);if(k+p<=g)k+=p,
l.appendChild(m);else break}else break;e.j.appendChild(l)}cj(e.u,"empty-overflow-list",0==ke(e.i).length)});
Sq()}}
...
function Gr(){J(document.body,"sitewide-ticker-visible");U("masthead-ticker-close")}
...
function ks(){Yr=F("appbar-content-trigger");(fs=H(document.body,"always-autohide-masthead"))?dk(Cr,"position-fixed"):bk(Cr,"position-fixed","true");fs||Yr?Mr=O(window,"scroll",ps):qs();$r=!!E("appbar-guide-menu")&&Qp();ds?($r||(cj(Mp,"guide-pinned",!1),Op(!1),Hp&&(Hp.scrollTop=0)),os()):ds=!0;var a=-1*kf(Pr).y,b=document.body.scrollHeight,c=a-(b-document.body.clientHeight);0<c&&(document.body.style.minHeight=""+b+c+"px");Zd(document).scrollTop+=a;Qr=Yd(document).y;rs();ss();Sq()}
function ls(){Yr=null;qs()}
function rs(){if(!Yr||es)ul(null,!0);else{var a=mf(Yr).height,b=mf(Pr).height;b=kf(Pr).y+b;a=Math.floor(kf(Yr).y)+a;var c=H(document.body,"appbar-hidden"),d=Zd(document);c&&a<b+40?(d.scrollTop+=40,ul(null,!0),J(document.body,"appbar-hidden"),ts()):!c&&b<a&&(d.scrollTop-=40,I(document.body,"appbar-hidden"),ts())}}
function ts(){es=!0;P(function(){es=!1;H(document.body,"appbar-hidden")&&ul(null,!1)},300)}
function os(){$r&&(cj(Mp,"guide-pinned",1251<=(window.innerWidth||document.documentElement.clientWidth)),Op(Rp()&&bs));us()}
function us(){if(document.body)if(H(document.body,"flex-width-enabled-snap")){var a=Rp()&&Pp();var b=(window.innerWidth||document.documentElement.clientWidth)-21-50;1251<=(window.innerWidth||document.documentElement.clientWidth)&&a&&(b-=230);a=1262<=b?"content-snap-width-3":1056<=b?"content-snap-width-2":"content-snap-width-1";H(cs,a)||(bj(cs,Zr),I(cs,a),U("yt-dom-content-change"))}else bj(cs,Zr)}
function vs(){return E("appbar-guide-menu")}
function is(){var a=H(document.body,"appbar-hidden"),b=kf(Pr).y,c=mf(Pr).height;Rr=a?b+c:b+c-40}
...
function ns(){var a=kf(Pr).y,b=mf(Pr).height;Or.style.height=""+a+b+"px";var c=vs();c&&(H(document.body,"appbar-hidden")?c.style.marginTop=""+a+b+"px":c.style.marginTop=a+b-40+"px",Sq());is()}
...
;function Gs(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";this.obfuscatedGaiaId=this.avatar=this.username="";this.h=!1;this.capabilities=new Set;this.experiments=new Set;this.theme="u";new rh;this.f=this.g="";a&&(this.id=a.id||a.name,this.name=a.name,this.app=a.app,this.type=a.type||"REMOTE_CONTROL",this.username=a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",Hs(this,a.capabilities||""),Is(this,a.experiments||""),this.g=
...
function Hs(a,b){a.capabilities.clear();ab(b.split(","),w(Mb,Vl)).forEach(function(c){a.capabilities.add(c)})}
...
;function Ks(a,b){Hf.call(this);this.f=new Ui(this.Ne,0,this);If(this,w(Jf,this.f));this.h=5E3;this.g=0;if(Ha(a))b&&(a=v(a,b));else if(a&&Ha(a.handleEvent))a=v(a.handleEvent,a);else throw Error("Invalid listener argument");this.i=a}
A(Ks,Hf);h=Ks.prototype;h.Ne=function(){this.h=Math.min(3E5,2*this.h);this.i();this.g&&this.start()};
...
A(Ls,Ii);h=Ls.prototype;h.subscribe=function(a,b,c){return this.h.subscribe(a,b,c)};
h.Gc=function(a,b){rj(this.h,a,b,void 0)};
h.ga=function(a){return this.h.ga(a)};
h.w=function(a,b){this.h.Z.apply(this.h,arguments)};
h.dispose=function(){this.A||(this.A=!0,Jf(this.h),Ms(this),Jf(this.g),this.g=null)};
h.K=function(){return this.A};
function Ns(a){return{firstTestResults:[""],secondTestResults:!a.f.Hb,sessionId:a.f.h,arrayId:a.f.Sa}}
h.connect=function(a,b,c){if(!this.f||2!=this.f.f){this.u="";this.g.stop();this.j=a||null;this.i=b||0;a=this.F+"/test";b=this.F+"/bind";var d=new mi(c?c.firstTestResults:null,c?c.secondTestResults:null,this.J),e=this.f;e&&(e.T=null);d.T=this;this.f=d;e?this.f.connect(a,b,this.l,e.h,e.Sa):c?this.f.connect(a,b,this.l,c.sessionId,c.arrayId):this.f.connect(a,b,this.l)}};
function Ms(a,b){a.G=b||0;a.g.stop();a.f&&(3==a.f.f&&Bi(a.f),ti(a.f));a.G=0}
h.sendMessage=function(a,b){var c={_sc:a};b&&Xb(c,b);this.g.isActive()||2==(this.f?this.f.f:0)?this.C.push(c):Os(this)&&Ai(this.f,c)};
h.jc=function(){this.g.reset();this.j=null;this.i=0;if(this.C.length){var a=this.C;this.C=[];for(var b=0,c=a.length;b<c;++b)Ai(this.f,a[b])}this.w("handlerOpened")};
...
h.sc=function(){var a={v:2};this.u&&(a.gsessionid=this.u);0!=this.i&&(a.ui=""+this.i);0!=this.G&&(a.ui=""+this.G);this.j&&Xb(a,this.j);return a};
h.ic=function(a){"S"==a[0]?this.u=a[1]:"gracefulReconnect"==a[0]?(this.g.start(),ti(this.f)):this.w("handlerMessage",new Js(a[0],a[1]))};
...
;function ct(a){this.port=this.domain="";this.f="/api/lounge";this.g=!0;a=a||document.location.href;var b=Number(Ie(a)[4]||null)||"";b&&(this.port=":"+b);this.domain=Ke(a)||"";a=Gb;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Eb(a,"10.0")&&(this.g=!1))}
...
;function pt(a){a=void 0===a?!1:a;Hf.call(this);this.l=new K(a);If(this,w(Jf,this.l))}
A(pt,Hf);pt.prototype.subscribe=function(a,b,c){return this.K()?0:this.l.subscribe(a,b,c)};
...
;function Qt(a,b){pt.call(this);this.u=b;var c=lq("yt-remote-online-screen-ids")||"";c=c?c.split(","):[];for(var d={},e=this.u(),f=0,g=e.length;f<g;++f){var k=e[f].id;d[k]=hb(c,k)}this.f=d;this.j=a;this.h=this.i=NaN;this.g=null;Rt("Initialized with "+gh(this.f))}
...
h.isEmpty=function(){return Rb(this.f)};
h.update=function(){Rt("Updating availability on schedule.");var a=this.u(),b=Kb(this.f,function(c,d){return c&&!!ot(a,d)},this);
Tt(this,b)};
...
function Tt(a,b){a:if(Lb(b)!=Lb(a.f))var c=!1;else{c=Ob(b);for(var d=0,e=c.length;d<e;++d)if(!a.f[c[d]]){c=!1;break a}c=!0}c||(Rt("Updated online screens: "+gh(a.f)),a.f=b,a.w("screenChange"));Vt(a)}
function St(a){isNaN(a.h)||Q(a.h);a.h=P(v(a.Vb,a),0<a.i&&a.i<y()?2E4:1E4)}
h.Vb=function(){Q(this.h);this.h=NaN;this.g&&this.g.abort();var a=Wt(this);if(Lb(a)){var b=dt(this.j,"/pairing/get_screen_availability");this.g=et(this.j,b,{lounge_token:Ob(a).join(",")},v(this.Le,this,a),v(this.Ke,this))}else Tt(this,{}),St(this)};
h.Le=function(a,b){this.g=null;a:{var c=Ob(Wt(this));var d=Ob(a);if(Ga(c)&&Ga(d)&&c.length==d.length){for(var e=c.length,f=0;f<e;f++)if(c[f]!==d[f]){c=!1;break a}c=!0}else c=!1}if(c){c=b.screens||[];d={};e=0;for(f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;Tt(this,d);St(this)}else this.M("Changing Screen set during request."),this.Vb()};
...
return b}
function Vt(a){a=Ob(Kb(a.f,function(b){return b}));
...
h.nd=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new ut(this.u,a,b,c);f.subscribe("pairingComplete",v(function(g){Jf(f);d(Zt(this,g))},this));
f.subscribe("pairingFailed",function(g){Jf(f);e(g)});
...
h.B=function(){Jf(this.h);Jf(this.g);Y.H.B.call(this)};
...
h.Ta=function(a){this.info("launchWithParams no-op for Cast: "+gh(a))};
...
function hu(a){a.info("sendYoutubeMessage_: getMdxSessionStatus "+gh(void 0));var b={type:"getMdxSessionStatus"};a.g?a.g.sendMessage("urn:x-cast:com.google.youtube.mdx",b,u,v(function(){eu(this,"Failed to send message: getMdxSessionStatus.")},a)):eu(a,"Sending yt message without session: "+gh(b))}
h.Te=function(a,b){if(!this.K())if(b){var c=bi(b);if(Ia(c)){var d=""+c.type;c=c.data||{};this.info("onYoutubeMessage_: "+d+" "+gh(c));switch(d){case "mdxSessionStatus":gu(this,c.screenId);break;default:eu(this,"Unknown youtube message: "+d)}}else eu(this,"Unable to parse message.")}else eu(this,"No data in message.")};
...
Vs(),this.g.subscribe("onlineScreenChange",v(this.od,this)),this.h=nu(this),chrome.cast.setCustomReceivers(this.h,u,v(function(g){this.M("Failed to set initial custom receivers: "+gh(g))},this)),this.w("yt-remote-cast2-availability-change",ou(this)),b(!0))},this),v(function(g){this.M("Failed to initialize API: "+gh(g));
b(!1)},this))};
...
u,v(function(e){this.M("Failed to set initial custom receivers: "+gh(e))},this)));
...
h.B=function(){this.g.Gc("onlineScreenChange",v(this.od,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.i);jb(t("yt.mdx.remote.debug.handlers_")||[],Ws);Jf(this.f);mu.H.B.call(this)};
...
function qu(a,b,c){b!=a.f&&(Jf(a.f),(a.f=b)?(c?a.w("yt-remote-cast2-receiver-resumed",b.f):a.w("yt-remote-cast2-receiver-selected",b.f),b.subscribe("sessionScreen",v(a.Vc,a,b)),b.h?a.w("yt-remote-cast2-session-change",b.h):c&&a.f.Ta(null)):a.w("yt-remote-cast2-session-change",null))}
...
chrome.cast.ReceiverType.CAST&&b.receiverType==chrome.cast.ReceiverType.CAST&&(pu("onSessionEstablished_: manual to cast session change "+b.friendlyName),Jf(this.f),this.f=new fu(this.g,b),this.f.subscribe("sessionScreen",v(this.Vc,this,this.f)),this.f.Ta(null));this.f.Wb(a)}}};
h.tf=function(){return this.f?this.f.pd():null};
h.Me=function(a){this.K()||(this.M("Failed to estabilish a session: "+gh(a)),a.code!=chrome.cast.ErrorCode.CANCEL&&qu(this,null))};
...
h.od=function(){this.K()||(this.h=nu(this),pu("Updating custom receivers: "+gh(this.h)),chrome.cast.setCustomReceivers(this.h,u,v(function(){this.M("Failed to set custom receivers.")},this)),this.w("yt-remote-cast2-availability-change",ou(this)))};
...
function tu(){var a=0<=Gb.search(/ (CrMo|Chrome|CriOS)\//);return yd||a}
...
function Nu(a){var b={};b.index=a.index;b.listId=a.listId;b.videoId=a.videoId;b.playerState=a.playerState;b.volume=a.volume;b.muted=a.muted;b.audioTrackId=a.audioTrackId;b.trackData=Vb(a.f);b.hasPrevious=a.l;b.hasNext=a.hasNext;b.playerTime=a.i;b.playerTimeAt=a.h;b.seekableStart=a.A;b.seekableEnd=a.u;b.duration=a.g;b.loadedTime=a.G;b.liveIngestionTime=a.j;return b}
...
h.playVideo=function(a,b,c,d,e,f,g){var k=Ru(this);c=c||0;var l={videoId:a,currentIndex:c};Mu(k,a,c);void 0!==b&&(Ku(k,b),l.currentTime=b);void 0!==d&&(l.listId=d);null!=e&&(l.playerParams=e);null!=f&&(l.clickTrackingParams=f);null!=g&&(l.locationInfo=gh(g));Tu(this,"setPlaylist",l);d||Wu(this,k)};
...
function jv(a,b){var c=b.params.videoId;delete b.params.videoId;c==a.D.videoId&&(Rb(b.params)?a.D.f=null:a.D.f=b.params,a.w("remotePlayerChange"))}
...
h.re=function(a){a.params?$u("Received: action="+a.action+", params="+gh(a.params)):$u("Received: action="+a.action+" {}");switch(a.action){case "loungeStatus":a=bi(a.params.devices);this.g=bb(a,function(c){return new Gs(c)});
...
hv(this,!1);break;case "remoteConnected":var b=new Gs(bi(a.params.device));fb(this.g,function(c){return c.equals(b)})||ib(this.g,b);
break;case "remoteDisconnected":b=new Gs(bi(a.params.device));lb(this.g,function(c){return c.equals(b)});
...
function gv(a,b,c){c?$u("Sending: action="+b+", params="+gh(c)):$u("Sending: action="+b);a.f.sendMessage(b,c)}
...
d,e,f,g)}a&&!t("yt.mdx.remote.initialized_")&&(z("yt.mdx.remote.initialized_",!0),yv("Initializing: "+gh(a)),zv.push(S("yt-remote-cast2-availability-change",function(){Lk("yt-remote-receiver-availability-change")})),zv.push(S("yt-remote-cast2-receiver-selected",function(){Av();
...
var tv=null,uv=null,Mv=null;function vv(){var a=Dv();if(Rb(a)){a=At();var b=lq("yt-remote-session-name")||"",c=lq("yt-remote-session-app")||"";a={device:"REMOTE_CONTROL",id:a,name:b,app:c,mdxVersion:3};z("yt.mdx.remote.channelParams_",a)}}
...
h.ya=function(){rp.prototype.ya.call(this);this.l=this.na();this.ba=parseInt(N(this.l,"max-title-length"),10)||0;this.F=Li(this,"create-button");this.j=Li(this,"cancel-button");this.u=Li(this,"privacy-button");var a=Mi(this);this.i=Li(this,"title-input");Jg(a,this.i,"keyup",this.Yc);Jg(a,this.i,"paste",this.Yc);Jg(a,this.l,"reset",this.Ae);Jg(a,this.l,"submit",this.Be);this.L=Li(this,"create-playlist-widget-privacy-menu");this.J=Li(this,"is-selected");a=S("yt-uix-menu-item-clicked",v(this.Fe,this));
this.ha.push(a)};
h.ua=function(){Qv(this);this.l=this.J=this.j=this.F=this.L=this.u=this.i=null;rp.prototype.ua.call(this)};
h.setVideoIds=function(a){Li(this,"video-ids-input").value=a};
h.Yc=function(){var a=vb(this.i.value).length;lk(this.F,0<a&&(!this.ba||a<=this.ba))};
h.Fe=function(a){qe(this.L,a)&&(a=De(a,"yt-ui-menu-item"),Rv(this,a),a=N(a,"value"),Li(this,"privacy-value-input").value=a)};
function Rv(a,b){var c=Om.getInstance();re(F(V(c,"content"),a.u),vb(ze(b)));J(F("is-selected",a.L),"is-selected");I(b,"is-selected");c=N(b,"privacy-state");bk(a.u,"privacy-state",c)}
function Sv(a,b){lk(a.F,b);a.j&&lk(a.j,b);lk(a.i,b);lk(a.u,b)}
function Qv(a){a.i.value="";var b=Li(a,"title-input-container");J(b,"yt-uix-form-error");ie(F("yt-uix-form-error-message",b));lk(a.u,!0);(b=F("is-selected",a.L))&&a.J&&b!=a.J&&Rv(a,a.J);lk(a.F,!1);a.j&&lk(a.j,!0);lk(a.i,!0)}
h.Be=function(a){a.preventDefault();a=this.l;var b={context:this,onSuccess:this.xe,onError:this.we};b=void 0===b?{}:b;b.method=a.method.toUpperCase();if("POST"==b.method){var c=b,d=[];hj(a,d,kj);c.postBody=d.join("&")}else{d=new rh;hj(a,d,jj);sh(d);c={};for(var e=0;e<d.f.length;e++){var f=d.f[e];c[f]=d.g[f]}d=b.ob||{};Xb(d,c);b.ob=d}hl(a.action,b);Sv(this,!1)};
...
h.we=function(a,b){if(b&&b.errors&&b.errors.length){var c=Li(this,"title-input-container"),d=b.errors[0];I(c,"yt-uix-form-error");if(d){var e=F("yt-uix-form-error-message",c);e?e.innerHTML=d:(d=ae("SPAN","yt-uix-form-error-message",document.createTextNode(String(d))),d.setAttribute("role","alert"),c.appendChild(d))}Sv(this,!0)}};
...
this.j=this.i=null}
ka(Tv,rp);Tv.prototype.ya=function(){rp.prototype.ya.call(this);this.i=E(N(this.na(),"dialog-id"));if(!this.i)throw Error("Cannot find create playlist widget dialog.");Jg(Mi(this),document,"click",this.l);var a=S("yt-uix-card-show",v(this.u,this));this.ha.push(a);a=F("create-playlist-widget-form",this.i);this.j=new Pv(this.A);Ni(this.j,a)};
...
Tv.prototype.u=function(a){a==this.na()&&Li(this.j,"title-input").focus()};function Uv(){Rl.call(this,"scroller");this.f={}}
...
function Aw(){var a=Lv();Jf(ow);ow=null;a?zw(a):U("queue-change",new pw(2))}
...
function cx(){var a=!1;if(!W||!vl(Wv)||!M("PAGE_NAME"))return dx(),a;var b=ex(),c=fx();gx()&&c&&b!=c&&(hx(c),b=c);c=!!M("LIST_ID");if(b=gx()&&!!b&&(b==M("VIDEO_ID")||b==Zv)&&!c){var d=E("player-playlist");d&&!bx()&&(J(Wv,"mole-notification"),he(d,pe),U("watch-queue-show",1),ix(),a=!0)}else oe()!=Wv&&(Wv.appendChild(pe),U("watch-queue-show",0),Ew(),a=!0);d=E("placeholder-playlist");b||c?xl(d):yl(d);dx();return a}
...
function Jw(a){oe()==Wv&&a.currentTarget==bw&&(a=Ak(a),a&&H(a,"overflow-menu-choice")||(ej(Wv,"mole-expanded"),ej(Wv,"mole-collapsed")))}
function Ow(a){var b=N(a.currentTarget,"action");ux[b](a.currentTarget)}
function Kw(){J(Wv,"mole-notification");H(Wv,"mole-expanded")&&Ew();Um(Om.getInstance(),dw)}
function Lw(a){H(a.currentTarget,"fade-out")&&(ie(a.currentTarget),lx(fx()),vx());Ew()}
function Iw(a){a=Be(a.currentTarget,null,"watch-queue-item");if(!H(a,"currently-playing")){var b=ke(iw);b=Za(b,a);rx(b);(a=N(a,"video-id"))&&W&&W.playVideo(a,0,b)}}
function Mw(){var a=!H(kw,"checked");W&&W.gd(a);wx(a)}
function Nw(){W&&W.qc()}
function Qw(a){var b=a.playlistId,c=a.Ve;b&&c&&(a={videoIds:Dw().join(","),fullListId:b,onSuccess:function(){Nm(c)}},Vv(a))}
function sx(a){H(a,"disabled")||(a=N(a,"video-id"))&&xx(a)}
...
function rx(a){if(nx()){yx();var b=ke(iw);b[a]&&I(b[a],"currently-playing");zx()}}
function yx(){if(nx()){var a=F("currently-playing",iw);a&&J(a,"currently-playing");zx()}}
...
function Xw(){vl(Wv)&&I(Wv,"mole-notification")}
function Ax(){var a=px()?qx()+1:0,b=Dw().length;0<a&&0<b?re(cw,Fp(aw,{count:a,total:b})):ge(cw)}
function mx(a){a?(yl(gw),xl(hw)):(yl(hw),xl(gw))}
function zx(){var a=Dw().length,b=1>=a,c=px()?qx():-1;ew.disabled=b||0==c;fw.disabled=b||c==a-1;Ax();if(0!=a){var d=null;a=ke(iw);B(a,function(e){var f=N(e,"video-id"),g=F("play-next",e);cj(F("goto-video-page",e),"disabled",gx()&&f==M("VIDEO_ID")&&!M("LIST_ID"));H(e,"currently-playing")?(d=e,yl(g)):d?(d=null,cj(g,"disabled",!0)):cj(g,"disabled",!1)})}}
function vx(){zx();0==Dw().length?Bx():(xl(Wv),cx()||U("watch-queue-show",oe()==Wv?0:1));U("watch-queue-update")}
function nx(){var a=le(iw);return!!a&&H(a,"watch-queue-item")}
...
function Uw(a){Dx=a}
function Vw(){var a=Lv();Jf(W);W=null;Q(Ex);Ex=NaN;ge(iw);vx();if(a){W=a;W.subscribe("proxyStateChange",Fx);W.subscribe("remotePlayerChange",Gx);W.subscribe("autoplayModeChange",Hx);W.subscribe("autoplayUpNext",Ix);var b=a.i.getAutoplayMode();Hx(b);b=a.i.getAutoplayVideoId();Ix(b);W.subscribe("autoplayDismissed",Jx);W.subscribe("nowAutoplaying",Kx);Dx=null;b=Ru(a).videoId;M("LIST_ID")&&b&&(b=Qe("/watch",{v:b}),Nm(b))}else Bx();2!=Dx&&(to(),U("watch-queue-remote-connection",!!a))}
function Hx(a){"UNSUPPORTED"==a?yl(jw):(a="ENABLED"==a,cj(kw,"checked",a),wx(a),xl(jw))}
function Ix(a){W&&(a||yl(nw))}
function Jx(){I(mw,"fade-out")}
function Kx(){J(mw,"fade-out")}
function wx(a){a=a?br("MDX_AUTOPLAY_ON"):br("MDX_AUTOPLAY_OFF");re(lw,a)}
function Bx(){oe()==Wv||Wv.appendChild(pe);var a=E("placeholder-playlist");M("LIST_ID")?xl(a):yl(a);a=Wv;J(a,"mole-expanded");I(a,"mole-collapsed");yl(Wv);dx();U("watch-queue-hide",0)}
...
disconnect:function(){Hv()}},ux={"play-next":function(a){H(a,"disabled")||(a=N(a,"video-id"))&&ox(a)},
"goto-video-page":sx},Gw=[],Rw=[],Ex=NaN,Dx=null;z("yt.www.guide.setup",Fq);z("yt.www.guide.selectGuideItem",function(a){if(up){var b=null,c=F("guide-item-selected",up);c&&(b=N(c,"serialized-endpoint")||"");b!=a&&(b&&J(c,"guide-item-selected"),a&&(a=Uq(a))&&I(a,"guide-item-selected"))}});
...
z("yt.www.notifications.inbox.handleNotificationsClick",function(){kr(0);if(!pr&&(H(rr,"yt-high-priority-notification")&&(xr(),qr&&tr&&(An.getInstance().show(tr),I(qr,"yt-uix-clickcard-active"))),!N(sr,"loaded"))){var a={action_get_notifications_flyout:1};a[M("XSRF_FIELD_NAME",void 0)]=M("XSRF_TOKEN",void 0);spf.load("/feed_ajax",{method:"POST",postData:Pe(a),onDone:function(){bk(sr,"loaded","true");var b=tr;J(b,"sb-notif-on");I(b,"sb-notif-off");Bk(sr,"click",Br,"yt-lockup-notification")}})}});
...
z("ytbin.www.pageframe.setup",function(){Yn("GUIDE_DELAYLOADED_CSS");Yn("PAGE_FRAME_DELAYLOADED_CSS",w(J,document.body,"delayed-frame-styles-not-in"),M("WAIT_TO_DELAYLOAD_FRAME_CSS")?"yt-www-pageFrameCssNotifications-load":null);jp=E("a11y-announcements-container");kp=E("a11y-announcements-message");S("a11y-announce",qp);S("init",np);if(op=E("a11y-skip-nav"))np(),O(op,"click",pp);null==lp&&mp();lp&&(aj(document.body,["yt-high-contrast-mode","yt-high-contrast-mode-"+lp]),Yn("HIGH_CONTRAST_MODE_CSS"));
