...
;function Vc(a){this.f=Oa(a.url,a.jg)}
...
;var ld=C("Opera"),D=C("Trident")||C("MSIE"),md=C("Edge"),nd=md||D,od=C("Gecko")&&!(-1!=ec.toLowerCase().indexOf("webkit")&&!C("Edge"))&&!(C("Trident")||C("MSIE"))&&!C("Edge"),pd=-1!=ec.toLowerCase().indexOf("webkit")&&!C("Edge"),qd=C("Macintosh"),rd=C("Windows"),sd=C("Android"),td=fd(),vd=C("iPad"),wd=C("iPod"),xd=gd();function yd(){var a=n.document;return a?a.documentMode:void 0}
...
return b}
;function $e(a,b,c,d){this.top=a;this.right=b;this.bottom=c;this.left=d}
h=$e.prototype;h.getHeight=function(){return this.bottom-this.top};
h.clone=function(){return new $e(this.top,this.right,this.bottom,this.left)};
...
h.round=function(){this.top=Math.round(this.top);this.right=Math.round(this.right);this.bottom=Math.round(this.bottom);this.left=Math.round(this.left);return this};function af(a,b,c,d){this.left=a;this.top=b;this.width=c;this.height=d}
af.prototype.clone=function(){return new af(this.left,this.top,this.width,this.height)};
af.prototype.ceil=function(){this.left=Math.ceil(this.left);this.top=Math.ceil(this.top);this.width=Math.ceil(this.width);this.height=Math.ceil(this.height);return this};
af.prototype.floor=function(){this.left=Math.floor(this.left);this.top=Math.floor(this.top);this.width=Math.floor(this.width);this.height=Math.floor(this.height);return this};
af.prototype.round=function(){this.left=Math.round(this.left);this.top=Math.round(this.top);this.width=Math.round(this.width);this.height=Math.round(this.height);return this};function bf(a,b,c){if("string"===typeof b)(b=cf(a,b))&&(a.style[b]=c);else for(var d in b){c=a;var e=b[d],f=cf(c,d);f&&(c.style[f]=e)}}
var df={};function cf(a,b){var c=df[b];if(!c){var d=Hc(b);c=d;void 0===a.style[d]&&(d=(pd?"Webkit":od?"Moz":D?"ms":ld?"O":null)+Ic(d),void 0!==a.style[d]&&(c=d));df[b]=c}return c}
function ef(a,b){var c=ee(a);return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""}
function ff(a,b){return ef(a,b)||(a.currentStyle?a.currentStyle[b]:null)||a.style&&a.style[b]}
function gf(a){try{var b=a.getBoundingClientRect()}catch(c){return{left:0,top:0,right:0,bottom:0}}D&&a.ownerDocument.body&&(a=a.ownerDocument,b.left-=a.documentElement.clientLeft+a.body.clientLeft,b.top-=a.documentElement.clientTop+a.body.clientTop);return b}
function hf(a){if(D&&!Fd(8))return a.offsetParent;var b=ee(a),c=ff(a,"position"),d="fixed"==c||"absolute"==c;for(a=a.parentNode;a&&a!=b;a=a.parentNode)if(11==a.nodeType&&a.host&&(a=a.host),c=ff(a,"position"),d=d&&"static"==c&&a!=b.documentElement&&a!=b.body,!d&&(a.scrollWidth>a.clientWidth||a.scrollHeight>a.clientHeight||"fixed"==c||"absolute"==c||"relative"==c))return a;return null}
function jf(a){for(var b=new $e(0,Infinity,Infinity,0),c=ce(a),d=c.f.body,e=c.f.documentElement,f=ne(c.f);a=hf(a);)if(!(D&&0==a.clientWidth||pd&&0==a.clientHeight&&a==d)&&a!=d&&a!=e&&"visible"!=ff(a,"overflow")){var g=kf(a),k=new $d(a.clientLeft,a.clientTop);g.x+=k.x;g.y+=k.y;b.top=Math.max(b.top,g.y);b.right=Math.min(b.right,g.x+a.clientWidth);b.bottom=Math.min(b.bottom,g.y+a.clientHeight);b.left=Math.max(b.left,g.x)}d=f.scrollLeft;f=f.scrollTop;b.left=Math.max(b.left,d);b.top=Math.max(b.top,f);
...
function kf(a){var b=ee(a),c=new $d(0,0);var d=b?ee(b):document;d=!D||Fd(9)||le(ce(d).f)?d.documentElement:d.body;if(a==d)return c;a=gf(a);b=me(ce(b).f);c.x=a.left+b.x;c.y=a.top+b.y;return c}
function lf(a){a=gf(a);return new $d(a.left,a.top)}
function mf(a){if(1==a.nodeType)return lf(a);a=a.changedTouches?a.changedTouches[0]:a;return new $d(a.clientX,a.clientY)}
function nf(a,b){"number"==typeof a&&(a=(b?Math.round(a):a)+"px");return a}
function of(a){var b=pf;if("none"!=ff(a,"display"))return b(a);var c=a.style,d=c.display,e=c.visibility,f=c.position;c.visibility="hidden";c.position="absolute";c.display="inline";a=b(a);c.display=d;c.position=f;c.visibility=e;return a}
function pf(a){var b=a.offsetWidth,c=a.offsetHeight,d=pd&&!b&&!c;return(void 0===b||d)&&a.getBoundingClientRect?(a=gf(a),new be(a.right-a.left,a.bottom-a.top)):new be(b,c)}
function qf(a){var b=kf(a);a=of(a);return new af(b.x,b.y,a.width,a.height)}
function rf(a){return"rtl"==ff(a,"direction")}
...
function uf(a){if(D){var b=tf(a,"paddingLeft"),c=tf(a,"paddingRight"),d=tf(a,"paddingTop");a=tf(a,"paddingBottom");return new $e(d,c,a,b)}b=ef(a,"paddingLeft");c=ef(a,"paddingRight");d=ef(a,"paddingTop");a=ef(a,"paddingBottom");return new $e(parseFloat(d),parseFloat(c),parseFloat(a),parseFloat(b))}
var vf={thin:2,medium:4,thick:6};function wf(a,b){if("none"==(a.currentStyle?a.currentStyle[b+"Style"]:null))return 0;var c=a.currentStyle?a.currentStyle[b+"Width"]:null;return c in vf?vf[c]:sf(a,c)}
function xf(a){if(D&&!Fd(9)){var b=wf(a,"borderLeft"),c=wf(a,"borderRight"),d=wf(a,"borderTop");a=wf(a,"borderBottom");return new $e(d,c,a,b)}b=ef(a,"borderLeftWidth");c=ef(a,"borderRightWidth");d=ef(a,"borderTopWidth");a=ef(a,"borderBottomWidth");return new $e(parseFloat(d),parseFloat(c),parseFloat(a),parseFloat(b))}
;var yf=(new Date).getTime();function zf(a){if(!a)return"";a=a.split("#")[0].split("?")[0];a=a.toLowerCase();0==a.indexOf("//")&&(a=window.location.protocol+a);/^[\w\-]*:\/\//.test(a)||(a=window.location.href);var b=a.substring(a.indexOf("://")+3),c=b.indexOf("/");-1!=c&&(b=b.substring(0,c));a=a.substring(0,a.indexOf("://"));if("http"!==a&&"https"!==a&&"chrome-extension"!==a&&"file"!==a&&"android-app"!==a&&"chrome-search"!==a&&"chrome-untrusted"!==a&&"app"!==a)throw Error("Invalid URI scheme in origin: "+a);c="";var d=b.indexOf(":");
if(-1!=d){var e=b.substring(d+1);b=b.substring(0,d);if("http"===a&&"80"!==e||"https"===a&&"443"!==e)c=":"+e}return a+"://"+b+c}
;function Af(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;p=m=0}
function b(q){for(var w=g,r=0;64>r;r+=4)w[r/4]=q[r]<<24|q[r+1]<<16|q[r+2]<<8|q[r+3];for(r=16;80>r;r++)q=w[r-3]^w[r-8]^w[r-14]^w[r-16],w[r]=(q<<1|q>>>31)&4294967295;q=e[0];var R=e[1],wa=e[2],L=e[3],zi=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var ud=L^R&(wa^L);var bg=1518500249}else ud=R^wa^L,bg=1859775393;else 60>r?(ud=R&wa|L&(R|wa),bg=2400959708):(ud=R^wa^L,bg=3395469782);ud=((q<<5|q>>>27)&4294967295)+ud+zi+bg+w[r]&4294967295;zi=L;L=wa;wa=(R<<30|R>>>2)&4294967295;R=q;q=ud}e[0]=e[0]+q&4294967295;e[1]=
...
;function Bf(a,b,c){var d=[],e=[];if(1==(Fa(c)?2:1))return e=[b,a],B(d,function(k){e.push(k)}),Cf(e.join(" "));
...
a=Cf(e.join(" "));a=[c,a];0==g.length||a.push(g.join(""));return a.join("_")}
function Cf(a){var b=Af();b.update(a);return b.wd().toLowerCase()}
;function Df(a){var b=zf(String(n.location.href)),c;(c=n.__SAPISID||n.__APISID||n.__OVERRIDE_SID)?c=!0:(c=new Td(document),c=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID"),c=!!c);if(c&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?n.__SAPISID:n.__APISID,c||(c=new Td(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){b=b?"SAPISIDHASH":"APISIDHASH";var d=String(n.location.href);return d&&c&&b?[b,Bf(zf(d),c,a||null)].join(" "):null}return null}
;function Ef(){}
Da(Ef);Ef.prototype.f=0;function Ff(){this.G=this.G;this.C=this.C}
Ff.prototype.G=!1;Ff.prototype.K=function(){return this.G};
Ff.prototype.dispose=function(){this.G||(this.G=!0,this.B())};
function Gf(a,b){a.G?b():(a.C||(a.C=[]),a.C.push(b))}
Ff.prototype.B=function(){if(this.C)for(;this.C.length;)this.C.shift()()};
function Hf(a){a&&"function"==typeof a.dispose&&a.dispose()}
;var If=!D||Fd(9),Jf=D&&!Ed("9"),Kf=function(){if(!n.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
...
;var Wf="closure_lm_"+(1E6*Math.random()|0),Xf={},Yf=0;function Zf(a,b,c,d,e){if(d&&d.once)return $f(a,b,c,d,e);if(Array.isArray(b)){for(var f=0;f<b.length;f++)Zf(a,b[f],c,d,e);return null}c=ag(c);return a&&a[Pf]?a.h.add(String(b),c,!1,Ia(d)?!!d.capture:!!d,e):cg(a,b,c,!1,d,e)}
...
if(!c)return c};
return b}
function $f(a,b,c,d,e){if(Array.isArray(b)){for(var f=0;f<b.length;f++)$f(a,b[f],c,d,e);return null}c=ag(c);return a&&a[Pf]?a.h.add(String(b),c,!0,Ia(d)?!!d.capture:!!d,e):cg(a,b,c,!0,d,e)}
...
return a[lg]}
;function mg(a){Ff.call(this);this.g=a;this.f={}}
A(mg,Ff);var ng=[];function og(a,b,c,d){Array.isArray(c)||(c&&(ng[0]=c.toString()),c=ng);for(var e=0;e<c.length;e++){var f=Zf(b,c[e],d||a.handleEvent,!1,a.g||a);if(!f)break;a.f[f.key]=f}}
function pg(a){mb(a.f,function(b,c){this.f.hasOwnProperty(c)&&ig(b)},a);
a.f={}}
mg.prototype.B=function(){mg.J.B.call(this);pg(this)};
mg.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented");};function qg(){Ff.call(this);this.h=new Tf(this);this.Ma=this;this.ma=null}
A(qg,Ff);qg.prototype[Pf]=!0;qg.prototype.addEventListener=function(a,b,c,d){Zf(this,a,b,c,d)};
...
A(sg,qg);h=sg.prototype;h.Wd=Ef.getInstance();h.getId=function(){return this.ga||(this.ga=":"+(this.Wd.f++).toString(36))};
...
return a.f}
;Bb("A AREA BUTTON HEAD INPUT LINK MENU META OPTGROUP OPTION PROGRESS STYLE SELECT SOURCE TEXTAREA TITLE TRACK".split(" "));function zg(a,b,c){Ff.call(this);this.f=null;this.i=!1;this.l=a;this.j=c;this.g=b||window;this.h=v(this.Hd,this)}
A(zg,Ff);h=zg.prototype;h.start=function(){this.stop();this.i=!1;var a=Ag(this),b=Bg(this);a&&!b&&this.g.mozRequestAnimationFrame?(this.f=Zf(this.g,"MozBeforePaint",this.h),this.g.mozRequestAnimationFrame(null),this.i=!0):this.f=a&&b?a.call(this.g,this.h):this.g.setTimeout(kb(this.h),20)};
...
;function Rg(a,b,c){Ff.call(this);this.f=a;this.i=b||0;this.g=c;this.h=v(this.tc,this)}
A(Rg,Ff);h=Rg.prototype;h.fb=0;h.B=function(){Rg.J.B.call(this);this.stop();delete this.f;delete this.g};
...
h.tc=function(){this.fb=0;this.f&&this.f.call(this.g)};function Sg(a,b,c){Ff.call(this);this.i=null!=c?v(a,c):a;this.h=b;this.g=v(this.Oe,this);this.f=[]}
A(Sg,Ff);h=Sg.prototype;h.Va=!1;h.kb=0;h.Ha=null;h.Id=function(a){this.f=arguments;this.Ha||this.kb?this.Va=!0:Tg(this)};
...
function Th(a){Sh(a);Hf(a.Bb);a.Bb=null;a.g.stop();pg(a.i);if(a.R){var b=a.R;a.R=null;b.abort();b.dispose()}a.la&&(a.la=null)}
...
h.isActive=function(){return!0};var nj=function(){if(rd){var a=/Windows NT ([0-9.]+)/;return(a=a.exec(ec))?a[1]:"0"}return qd?(a=/10[_.][0-9_.]+/,(a=a.exec(ec))?a[0].replace(/_/g,"."):"10"):sd?(a=/Android\s+([^\);]+)(\)|;)/,(a=a.exec(ec))?a[1]:""):td||vd||wd?(a=/(?:iPhone|CPU)\s+OS\s+(\S+)/,(a=a.exec(ec))?a[1].replace(/_/g,"."):""):""}();function oj(a){return(a=a.exec(ec))?a[1]:""}
var pj=function(){if(Jd)return oj(/Firefox\/([0-9.]+)/);if(D||md||ld)return Dd;if(Nd)return gd()?oj(/CriOS\/([0-9.]+)/):oj(/Chrome\/([0-9.]+)/);if(Od&&!gd())return oj(/Version\/([0-9.]+)/);if(Kd||Ld){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(ec);if(a)return a[1]+"."+a[2]}else if(Md)return(a=oj(/Android\s+([0-9.]+)/))?a:oj(/Version\/([0-9.]+)/);return""}();function qj(a,b,c,d,e,f,g){var k;if(k=c.offsetParent){var l="HTML"==k.tagName||"BODY"==k.tagName;if(!l||"static"!=ff(k,"position")){var m=kf(k);if(!l){l=rf(k);var p;if(p=l){if(p=Od)p=0<=Ub(pj,10);var q;if(q=xd)q=0<=Ub(nj,10);p=od||p||q}l=p?-k.scrollLeft:!l||nd&&Ed("8")||"visible"==ff(k,"overflowX")?k.scrollLeft:k.scrollWidth-k.clientWidth-k.scrollLeft;m=ae(m,new $d(l,k.scrollTop))}}}k=m||new $d;m=qf(a);if(l=jf(a)){var w=new af(l.left,l.top,l.right-l.left,l.bottom-l.top);l=Math.max(m.left,w.left);
p=Math.min(m.left+m.width,w.left+w.width);l<=p&&(q=Math.max(m.top,w.top),w=Math.min(m.top+m.height,w.top+w.height),q<=w&&(m.left=l,m.top=q,m.width=p-l,m.height=w-q))}l=ce(a);q=ce(c);if(l.f!=q.f){p=l.f.body;q=oe(q.f);w=new $d(0,0);var r=(r=ee(p))?oe(r):window;if(id(r,"parent")){var R=p;do{var wa=r==q?kf(R):lf(R);w.x+=wa.x;w.y+=wa.y}while(r&&r!=q&&r!=r.parent&&(R=r.frameElement)&&(r=r.parent))}p=ae(w,kf(p));!D||Fd(9)||le(l.f)||(p=ae(p,me(l.f)));m.left+=p.x;m.top+=p.y}a=rj(a,b);b=m.left;a&4?b+=m.width:
a&2&&(b+=m.width/2);b=new $d(b,m.top+(a&1?m.height:0));b=ae(b,k);e&&(b.x+=(a&4?-1:1)*e.x,b.y+=(a&1?-1:1)*e.y);var L;g&&(L=jf(c))&&(L.top-=k.y,L.right-=k.x,L.bottom-=k.y,L.left-=k.x);e=L;L=b.clone();b=rj(c,d);d=of(c);a=d.clone();L=L.clone();a=a.clone();k=0;if(f||0!=b)b&4?L.x-=a.width+(f?f.right:0):b&2?L.x-=a.width/2:f&&(L.x+=f.left),b&1?L.y-=a.height+(f?f.bottom:0):f&&(L.y+=f.top);g&&(e?(f=L,b=a,k=0,65==(g&65)&&(f.x<e.left||f.x>=e.right)&&(g&=-2),132==(g&132)&&(f.y<e.top||f.y>=e.bottom)&&(g&=-5),f.x<
...
g&4&&(f.y=Math.max(e.bottom-b.height,e.top),k|=2),g&8&&(k|=(f.y<e.top?64:0)|(f.y+b.height>e.bottom?128:0)),g=k):g=256,k=g);f=new af(0,0,0,0);f.left=L.x;f.top=L.y;f.width=a.width;f.height=a.height;g=k;g&496||(L=new $d(f.left,f.top),L instanceof $d?(e=L.x,L=L.y):(e=L,L=void 0),c.style.left=nf(e,!1),c.style.top=nf(L,!1),a=new be(f.width,f.height),d==a||d&&a&&d.width==a.width&&d.height==a.height||(f=a,e=le(ce(ee(c)).f),!D||Ed("10")||e&&Ed("8")?(c=c.style,od?c.MozBoxSizing="border-box":pd?c.WebkitBoxSizing=
"border-box":c.boxSizing="border-box",c.width=Math.max(f.width,0)+"px",c.height=Math.max(f.height,0)+"px"):(d=c.style,e?(e=uf(c),c=xf(c),d.pixelWidth=f.width-c.left-e.left-e.right-c.right,d.pixelHeight=f.height-c.top-e.top-e.bottom-c.bottom):(d.pixelWidth=f.width,d.pixelHeight=f.height))));return g}
function rj(a,b){return(b&8&&rf(a)?b^4:b)&-9}
;function K(a){Ff.call(this);this.j=1;this.h=[];this.i=0;this.f=[];this.g={};this.l=!!a}
A(K,Ff);h=K.prototype;h.subscribe=function(a,b,c){var d=this.g[a];d||(d=this.g[a]=[]);var e=this.j;this.f[e]=a;this.f[e+1]=b;this.f[e+2]=c;this.j=e+3;d.push(e);return e};
...
function tl(a,b){if(!Xj("web_use_beacon_api_for_ad_click_server_pings"))return!1;if(Xj("use_sonic_library_for_v4_support"))try{var c=Lc(Kc(a)[5]||null);if(!c||!c.endsWith("/aclk")||!(new Vc({url:a})).f)return!1}catch(d){return vk(Error("ClickUrl library throws error, url = "+a)),!1}else if(c=Lc(Kc(a)[5]||null),!c||-1==c.indexOf("/aclk")||"1"!==Uc(a,"ae")||"1"!==Uc(a,"act"))return!1;return vl(a)?(b&&b(),!0):!1}
...
function zm(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||M("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.ag||M("AUTHORIZATION"))||(a?b="Bearer "+t("gapi.auth.getToken")().Xf:b=Df([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=M("SESSION_INDEX",0),Yj("pageid_as_header_web")&&(d["X-Goog-PageId"]=M("DELEGATED_SESSION_ID")));return d}
function Am(a){a=Object.assign({},a);delete a.Authorization;var b=Df();if(b){var c=new Vg;c.update(M("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ga(b);void 0===c&&(c=0);if(!Qd){Qd={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));Pd[f]=g;for(var k=0;k<g.length;k++){var l=g[k];void 0===Qd[l]&&(Qd[l]=k)}}}c=Pd[c];d=[];for(e=0;e<b.length;e+=3){var m=b[e],p=(f=e+1<b.length)?
...
z("yt_logging_screen.setCurrentScreen",function(a,b,c,d){c=void 0===c?0:c;if(a!==M(Km(c))||b!==M(Lm(c)))Om(a,d,c),Tj(Km(c),a),Tj(Lm(c),b),0==c&&(b=function(){setTimeout(function(){a&&xm("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Jm,clientScreenNonce:a},Gm)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())});function Pm(a){var b=void 0===b?{}:b;var c=void 0===c?"":c;var d=void 0===d?window:d;d=d.location;a=Sc(a,b)+c;a=a instanceof Wb?a:dc(a);d.href=Zb(a)}
...
function Vm(a,b,c,d){var e=Re(b,V(a,"group")),f=!!a.H(b,"button-menu-ignore-group");e=e&&!f?e:b;f=9;var g=8,k=qf(b);if(G(b,V(a,"reverse"))){f=8;g=9;k=k.top+"px";try{c.style.maxHeight=k}catch(p){}}G(b,"flip")&&(G(b,V(a,"reverse"))?(f=12,g=13):(f=13,g=12));var l;a.H(b,"button-has-sibling-menu")?l=hf(e):a.H(b,"button-menu-root-container")&&(l=an(a,b));D&&!Ed("8")&&(l=null);if(l){var m=qf(l);m=new $e(-m.top,m.left,m.top,-m.left)}l=new $d(0,1);G(b,V(a,"center-menu"))&&(l.x-=Math.round((of(c).width-of(b).width)/
2));d&&(l.y+=me(document).y);if(a=$m(a,b))b=of(c),a.style.width=b.width+"px",a.style.height=b.height+"px",qj(e,f,a,g,l,m,197),d&&bf(a,"position","fixed");qj(e,f,c,g,l,m,197)}
...
function fn(a,b,c){var d=a.H(b,"orientation")||"horizontal",e=F(V(a,"anchor"),b)||b,f=a.H(b,"position"),g=!!a.H(b,"force-position"),k=a.H(b,"position-fixed");d="horizontal"==d;var l="bottomright"==f||"bottomleft"==f,m="topright"==f||"bottomright"==f;if(m&&l){var p=13;var q=8}else m&&!l?(p=12,q=9):!m&&l?(p=9,q=12):(p=8,q=13);var w=rf(document.body);f=rf(b);w!=f&&(p^=4);if(d){f=b.offsetHeight/2-12;var r=new $d(-12,b.offsetHeight+6)}else f=b.offsetWidth/2-6,r=new $d(b.offsetWidth+6,-12);var R=of(c);
f=Math.min(f,(d?R.height:R.width)-24-6);6>f&&(f=6,d?r.y+=12-b.offsetHeight/2:r.x+=12-b.offsetWidth/2);R=null;g||(R=10);b=V(a,"card-flip");a=V(a,"card-reverse");bh(c,b,m);bh(c,a,l);R=qj(e,p,c,q,r,null,R);!g&&R&&(R&48&&(m=!m,p^=4,q^=4),R&192&&(l=!l,p^=1,q^=1),bh(c,b,m),bh(c,a,l),qj(e,p,c,q,r));k&&(e=parseInt(c.style.top,10),g=me(document).y,bf(c,"position","fixed"),bf(c,"top",e-g+"px"));w&&(c.style.right="",e=qf(c),e.left=e.left||parseInt(c.style.left,10),g=ke(window),c.style.left="",c.style.right=
g.width-e.left-e.width+"px");e=F("yt-uix-card-body-arrow",c);g=F("yt-uix-card-border-arrow",c);d=d?l?"top":"bottom":!w&&m||w&&!m?"left":"right";e.setAttribute("style","");g.setAttribute("style","");e.style[d]=f+"px";g.style[d]=f+"px";l=F("yt-uix-card-arrow",c);m=F("yt-uix-card-arrow-background",c);l&&m&&(c="right"==d?of(c).width-f-13:f+11,f=c/Math.sqrt(2),l.style.left=c+"px",l.style.marginLeft="1px",m.style.marginLeft=-f+"px",m.style.marginTop=f+"px")}
...
this.l={};Hf(this.i);this.i=null;on.J.unregister.call(this)};
...
function tn(a,b,c){var d=un(a,b);if(d){var e=of(c);if(e instanceof be){var f=e.height;e=e.width}else throw Error("missing height argument");d.style.width=nf(e,!0);d.style.height=nf(f,!0)}c==a.f&&(e=9,f=8,G(b,V(a,"reversed"))&&(e^=1,f^=1),G(b,V(a,"flipped"))&&(e^=4,f^=4),a=new $d(0,1),d&&qj(b,e,d,f,a,null,197),qj(b,e,c,f,a,null,197))}
...
;function ao(){Ff.call(this);this.f=[]}
sa(ao,Ff);ao.prototype.B=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.cg)}Ff.prototype.B.call(this)};var bo=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function co(a,b){a=a||"";if(window.spf){var c=a.match(bo);spf.style.load(a,c?c[1]:"",b);return null}return eo(a,b)}
...
;function io(a,b,c,d){Ff.call(this);var e=this;this.l=this.na=a;this.ma=b;this.u=!1;this.api={};this.aa=this.I=null;this.F=new K;Gf(this,x(Hf,this.F));this.i={};this.N=this.ga=this.g=this.Hb=this.f=null;this.L=!1;this.j=this.A=null;this.Ma={};this.rd=["onReady"];this.Za=null;this.Zb=NaN;this.O={};this.h=d;jo(this);this.pb("WATCH_LATER_VIDEO_ADDED",this.De.bind(this));this.pb("WATCH_LATER_VIDEO_REMOVED",this.Ee.bind(this));this.pb("onAdAnnounce",this.td.bind(this));this.sd=new ao(this);Gf(this,x(Hf,
this.sd));this.S=0;c?this.S=P(function(){e.loadNewVideoConfig(c)},0):d&&(ko(this),lo(this))}
sa(io,Ff);h=io.prototype;h.getId=function(){return this.ma};
h.loadNewVideoConfig=function(a){if(!this.K()){this.S&&(Q(this.S),this.S=0);a instanceof On||(a=new On(a));this.Hb=a;this.f=a.clone();ko(this);this.ga||(this.ga=mo(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=nf(Number(a)||a,!0);if(a=this.f.attrs.height)this.l.style.height=nf(Number(a)||a,!0);lo(this);this.u&&no(this)}};
...
h.B=function(){so(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){uk(b)}this.Ma=null;for(var a in this.i)n[this.i[a]]=null;this.Hb=this.f=this.api=null;delete this.na;delete this.l;Ff.prototype.B.call(this)};
...
"getBrowseRequestId",X.GetLibrary_rid="getLibraryRequestId",X.is_continuation="isContinuation",X.is_nav="isNavigation",X.b_p="kabukiInfo.browseParams",X.is_prefetch="kabukiInfo.isPrefetch",X.is_secondary_nav="kabukiInfo.isSecondaryNav",X.prev_browse_id="kabukiInfo.prevBrowseId",X.query_source="kabukiInfo.querySource",X.voz_type="kabukiInfo.vozType",X.yt_lt="loadType",X.mver="creatorInfo.measurementVersion",X.yt_ad="isMonetized",X.nr="webInfo.navigationReason",X.nrsu="navigationRequestedSameUrl",X.ncnp=
"webInfo.nonPreloadedNodeCount",X.pnt="performanceNavigationTiming",X.prt="playbackRequiresTap",X.plt="playerInfo.playbackType",X.pis="playerInfo.playerInitializedState",X.paused="playerInfo.isPausedOnLoad",X.yt_pt="playerType",X.fmt="playerInfo.itag",X.yt_pl="watchInfo.isPlaylist",X.yt_pre="playerInfo.preloadType",X.yt_ad_pr="prerollAllowed",X.pa="previousAction",X.yt_red="isRedSubscriber",X.rce="mwebInfo.responseContentEncoding",X.scrh="screenHeight",X.scrw="screenWidth",X.st="serverTimeMs",X.aq=
...
X.GetSettings_rid="mwebInfo.getSettingsRequestId",X.GetTrending_rid="mwebInfo.getTrendingRequestId",X.GetMusicSearchSuggestions_rid="musicInfo.getMusicSearchSuggestionsRequestId",X),cp="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),dp={},
ep=(dp.mver="MEASUREMENT_VERSION_",dp.pis="PLAYER_INITIALIZED_STATE_",dp.yt_pt="LATENCY_PLAYER_",dp.pa="LATENCY_ACTION_",dp.yt_vst="VIDEO_STREAM_TYPE_",dp),fp="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
...
T.Nc=function(){zc(E("yt-consent-iframe"),new Hb(Ib,Fb(new Cb(Db,"about:blank"))))};var pp,qp,rp;function sp(){var a=ce(),b=a.f,c=a.createElement("div");c.style.backgroundColor="rgb(1, 2, 3)";a.appendChild(b.body,c);b=ef(c,"backgroundColor");b=b.replace(/ /g,"");rp="rgb(0,0,0)"===b?"black":"rgb(255,255,255)"===b?"white":null;a.Jd(c)}
;function tp(){ek(up,"target-id","content")}
function vp(){var a=E(N(up,"target-id"));a.setAttribute("tabindex","0");a.focus();a=kf(E("page-container")).y;window.scrollBy(0,-a)}
...
function Ep(a,b){return"vertical"==a.A?of(b).height:of(b).width}
...
function Xq(a){a=a.currentTarget;var b=F("guide-flyout",a),c=F("guide-flyout-trigger",a),d=F("guide-flyout-iframe-mask",a),e=F("guide-flyout",a),f=uf(e),g=F("guide-channels-list",a),k=Gq(!0),l=F("guide-flyout-trigger",a),m=F("guide-flyout-iframe-mask",a),p=k.height-(Np?Np.offsetTop:0);g.style.maxHeight=p-f.top-f.bottom+"px";f=of(e).height;g=of(l);l=mf(l);p=Math.min(p-f,Math.max(0,k.height-l.y-g.height/2-f/2));g=l.x+g.width;k=k.width-l.x;e.style.bottom=p+"px";m&&(m.style.height=f+"px",m.style.bottom=
...
function Yq(){Op&&Np&&(Op.style.height=of(Np).height+"px",Op.style.marginTop=Np.style.marginTop,Op.style.top=Np.style.top)}
...
function Oq(a){Np&&bf(Np,"max-height",a.height-50+"px")}
...
Yq()}}
function ar(a){var b=Np,c=E("guide-container");if(!c||!b)return 0;var d=uf(c);d=d.top+d.bottom;c=ze(c).clientHeight;var e=0;B(Kq,function(f){e+=f.j?Dp(f,f.j):0;e+=0==ye(f.g).length?0:f.l?Ep(f,f.l):0});
...
function qs(){ds=F("appbar-content-trigger");(ls=G(document.body,"always-autohide-masthead"))?gk(Ir,"position-fixed"):ek(Ir,"position-fixed","true");ls||ds?Sr=O(window,"scroll",vs):ws();fs=!!E("appbar-guide-menu")&&Wp();js?(fs||(bh(Sp,"guide-pinned",!1),Up(!1),Np&&(Np.scrollTop=0)),us()):js=!0;var a=-1*mf(Vr).y,b=document.body.scrollHeight,c=a-(b-document.body.clientHeight);0<c&&(document.body.style.minHeight=""+b+c+"px");ne(document).scrollTop+=a;Wr=me(document).y;xs();ys();Yq()}
function rs(){ds=null;ws()}
function xs(){if(!ds||ks)xl(null,!0);else{var a=of(ds).height,b=of(Vr).height;b=mf(Vr).y+b;a=Math.floor(mf(ds).y)+a;var c=G(document.body,"appbar-hidden"),d=ne(document);c&&a<b+40?(d.scrollTop+=40,xl(null,!0),I(document.body,"appbar-hidden"),zs()):!c&&b<a&&(d.scrollTop-=40,H(document.body,"appbar-hidden"),zs())}}
...
function os(){var a=G(document.body,"appbar-hidden"),b=mf(Vr).y,c=of(Vr).height;Xr=a?b+c:b+c-40}
...
function ts(){var a=mf(Vr).y,b=of(Vr).height;Ur.style.height=""+a+b+"px";var c=Bs();c&&(G(document.body,"appbar-hidden")?c.style.marginTop=""+a+b+"px":c.style.marginTop=a+b-40+"px",Yq());os()}
...
function Js(a,b,c){if(c&&c.html){ek(a,"loaded",1);a.innerHTML=c.html;Ks(a);c=(b=document.body||ne(document))||ne(document);var d=kf(a),e=kf(c),f=xf(c);if(c==ne(document)){var g=d.x-c.scrollLeft;d=d.y-c.scrollTop;D&&!Fd(10)&&(g+=f.left,d+=f.top)}else g=d.x-e.x-f.left,d=d.y-e.y-f.top;f=pf(a);e=c.clientHeight-f.height;var k=c.scrollLeft,l=c.scrollTop;k+=Math.min(g,Math.max(g-(c.clientWidth-f.width),0));l+=Math.min(d,Math.max(d-e,0));c=new $d(k,l);b.scrollLeft=c.x;b.scrollTop=c.y;F("yt-close",a).focus()}else Bl(a)}
...
;function Qs(a,b){Ff.call(this);this.f=new Rg(this.Ne,0,this);Gf(this,x(Hf,this.f));this.h=5E3;this.g=0;if(Ha(a))b&&(a=v(a,b));else if(a&&Ha(a.handleEvent))a=v(a.handleEvent,a);else throw Error("Invalid listener argument");this.i=a}
A(Qs,Ff);h=Qs.prototype;h.Ne=function(){this.h=Math.min(3E5,2*this.h);this.i();this.g&&this.start()};
...
h.dispose=function(){this.A||(this.A=!0,Hf(this.h),Ss(this),Hf(this.g),this.g=null)};
...
;function vt(a){a=void 0===a?!1:a;Ff.call(this);this.l=new K(a);Gf(this,x(Hf,this.l))}
A(vt,Ff);vt.prototype.subscribe=function(a,b,c){return this.K()?0:this.l.subscribe(a,b,c)};
...
h.ld=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new Bt(this.u,a,b,c);f.subscribe("pairingComplete",v(function(g){Hf(f);d(eu(this,g))},this));
f.subscribe("pairingFailed",function(g){Hf(f);e(g)});
...
h.B=function(){Hf(this.h);Hf(this.g);Y.J.B.call(this)};
...
h.B=function(){this.g.Ec("onlineScreenChange",v(this.md,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.i);ab(t("yt.mdx.remote.debug.handlers_")||[],bt);Hf(this.f);su.J.B.call(this)};
...
function wu(a,b,c){b!=a.f&&(Hf(a.f),(a.f=b)?(c?a.w("yt-remote-cast2-receiver-resumed",b.f):a.w("yt-remote-cast2-receiver-selected",b.f),b.subscribe("sessionScreen",v(a.Tc,a,b)),b.h?a.w("yt-remote-cast2-session-change",b.h):c&&a.f.Sa(null)):a.w("yt-remote-cast2-session-change",null))}
...
chrome.cast.ReceiverType.CAST&&b.receiverType==chrome.cast.ReceiverType.CAST&&(vu("onSessionEstablished_: manual to cast session change "+b.friendlyName),Hf(this.f),this.f=new lu(this.g,b),this.f.subscribe("sessionScreen",v(this.Tc,this,this.f)),this.f.Sa(null));this.f.Ub(a)}}};
...
function Gw(){var a=Rv();Hf(uw);uw=null;a?Fw(a):U("queue-change",new vw(2))}
