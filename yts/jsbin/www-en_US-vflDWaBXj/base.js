...
g.bc=function(a){if(a instanceof g.Yb)return a;var b="object"==typeof a,c=null;b&&a.Rk&&(c=a.C());return g.ac(g.bb(b&&a.Md?a.Uc():String(a)),c)};
...
g.Yc=function(a,b){var c=String(b[0]),d=b[1];if(!maa&&d&&(d.name||d.type)){c=["<",c];d.name&&c.push(' name="',g.ic(d.name),'"');if(d.type){c.push(' type="',g.ic(d.type),'"');var e={};g.sb(e,d);delete e.type;d=e}c.push(">");c=c.join("")}c=g.$c(a,c);d&&("string"===typeof d?c.className=d:g.Ba(d)?c.className=d.join(" "):g.Uc(c,d));2<b.length&&g.ad(a,c,b,2);return c};
...
g.be=function(a,b,c,d,e){if(d&&d.once)return g.ae(a,b,c,d,e);if(g.Ba(b)){for(var f=0;f<b.length;f++)g.be(a,b[f],c,d,e);return null}c=g.ce(c);return g.Wd(a)?a.O(b,c,g.Ea(d)?!!d.capture:!!d,e):de(a,b,c,!1,d,e)};
...
if(!c)return c};
return b};
g.ae=function(a,b,c,d,e){if(g.Ba(b)){for(var f=0;f<b.length;f++)g.ae(a,b[f],c,d,e);return null}c=g.ce(c);return g.Wd(a)?a.Be(b,c,g.Ea(d)?!!d.capture:!!d,e):de(a,b,c,!0,d,e)};
g.je=function(a,b,c,d,e){if(g.Ba(b))for(var f=0;f<b.length;f++)g.je(a,b[f],c,d,e);else d=g.Ea(d)?!!d.capture:!!d,c=g.ce(c),g.Wd(a)?a.Va(b,c,d,e):a&&(a=g.ee(a))&&(b=a.We(b,c,d,e))&&g.ke(b)};
...
if("undefined"!==typeof a&&!g.tb()){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.jn;c.jn=null;e()}};
return function(e){d.next={jn:e};d=d.next;b.port2.postMessage(0)}}return"undefined"!==typeof document&&"onreadystatechange"in g.bd("SCRIPT")?function(e){var f=g.bd("SCRIPT");
...
g.Ge=function(a,b,c){0==a.C&&(a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself")),a.C=1,Le(c,a.Y,a.M,a)||(a.N=c,a.C=b,a.D=null,Te(a),3!=b||c instanceof g.Ve||Baa(a,c)))};
...
g.Ag=function(a){var b=[];g.ib(a,function(c,d){var e=g.gc(d),f;g.Ba(c)?f=c:f=[c];(0,g.B)(f,function(k){""==k?b.push(e):b.push(e+"="+g.gc(k))})});
return b.join("&")};
...
g.Gg=function(a){var b=g.Id(a.C),c=g.Hd(a.C.top),d={};return d.bc=g.Od(),d.bih=c.height,d.biw=c.width,d.brdim=b.join(),d.vis=g.Pd(a.F),d.wgl=!!g.Dd.WebGLRenderingContext,d};
...
return d};
Wg=function(a){if(g.Ea(a))for(var b in a)"html_content"==b||g.Ua(b,"_html")?a[b]=g.cc(a[b],null):Wg(a[b])};
...
g.ih=function(a,b,c,d){d=void 0===d?{}:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return g.kb(hh,function(e){var f="boolean"===typeof e[4]&&e[4]==!!d,k=g.Ea(e[4])&&g.Ea(d)&&g.ob(e[4],d);return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&(f||k)})};
g.J=function(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=g.ih(a,b,c,d);if(e)return e;e=++jh.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var k=f?function(l){l=new g.dh(l);if(!g.fd(l.relatedTarget,function(m){return m==a},!0))return l.currentTarget=a,l.type=b,c.call(a,l)}:function(l){l=new g.dh(l);
...
sh=function(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||g.pb(b);this.assets=a.assets||{};this.attrs=a.attrs||g.pb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}};
g.th=function(a){a instanceof sh||(a=new sh(a));return a};
g.uh=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(g.ea(c))};
...
g.Uh=function(a){var b=void 0===a?{}:a;a=void 0===b.by?!0:b.by;b=void 0===b.JF?!1:b.JF;if(null==g.u("_lact",window)){var c=parseInt(g.E("LACT"),10);c=isFinite(c)?(0,g.Lc)()-Math.max(c,0):-1;g.r("_lact",c,window);g.r("_fact",c,window);-1==c&&g.Sh();g.J(document,"keydown",g.Sh);g.J(document,"keyup",g.Sh);g.J(document,"mousedown",g.Sh);g.J(document,"mouseup",g.Sh);a&&(b?g.J(window,"touchmove",function(){Th("touchmove",200)},{passive:!0}):(g.J(window,"resize",function(){Th("resize",200)}),g.J(window,
...
ci=function(a){a=Object.assign({},a);delete a.Authorization;var b=Ld();if(b){var c=new af;c.update(g.E("INNERTUBE_API_KEY",void 0));c.update(b);a.hash=xc(c.digest(),3)}return a};
...
63));return a.join("")};
g.vi=function(a){if("FOREGROUND_HEARTBEAT_TRIGGER_ON_BACKGROUND"==a||"FOREGROUND_HEARTBEAT_TRIGGER_ON_FOREGROUND"==a){if(ri==a)return;ri=a}var b=9E4+2E3*Math.random();if("FOREGROUND_HEARTBEAT_TRIGGER_ON_INTERVAL"!=a||!(g.Wh()>b)&&"visible"==g.ch()){b=-1;g.si&&(b=Math.round((0,g.Gh)()-g.si));var c=String;var d=g.u("_fact",window);d=null==d||-1==d?-1:Math.max((0,g.Lc)()-d,0);a={firstActivityMs:c(d),clientDocumentNonce:ti,index:String(ui),lastEventDeltaMs:String(b),trigger:a};g.$h("foregroundHeartbeat",
...
jba=function(a){if(Si){for(var b=g.da(Si),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,g.$h(c.zF,c.payload,null,c.options));Si.length=0}Ti=0};
...
g.fj=function(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=g.gb,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a=g.Lb(g.Pb(a)),"about:invalid#zClosurez"===a?a="":(a=g.$b(g.bc(a)),a=g.gc(g.of(a))),g.Va(a)||(a=g.Zc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),g.ed(a).body.appendChild(a))):e?Qg(a,b,"POST",e,d):g.E("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Qg(a,b,"GET","",d):mba(a,b)||nba(a,b))};
...
vj=function(a,b,c,d){g.C.call(this);var e=this;this.L=this.Ya=a;this.ha=b;this.N=!1;this.api={};this.na=this.M=null;this.Y=new g.rf;g.Sd(this,this.Y);this.G={};this.la=this.qa=this.F=this.ob=this.C=null;this.T=!1;this.H=this.J=null;this.jb={};this.Pd=["onReady"];this.mb=null;this.sb=NaN;this.X={};this.D=d;sj(this);this.Jh("WATCH_LATER_VIDEO_ADDED",this.fD.bind(this));this.Jh("WATCH_LATER_VIDEO_REMOVED",this.gD.bind(this));this.Jh("onAdAnnounce",this.Ct.bind(this));this.Hb=new rh(this);g.Sd(this,this.Hb);
...
rba=function(a,b){var c="ytPlayer"+b+a.ha;a.G[b]=c;g.p[c]=function(d){var e=g.Wf(function(){a.qb()||(a.Y.oa(b,d),g.mb(a.X,String(e)))},0);
g.nb(a.X,String(e),!0)};
return c};
...
g.tk=function(a,b,c){var d=Rj(c);if(g.vg("use_first_tick")&&zk(a,c))return d[a];if(!b&&"_"!=a[0]){var e=a;Oj.mark&&(g.Ta(e,"mark_")||(e="mark_"+e),c&&(e+=" ("+c+")"),Oj.mark(e))}e=b||(0,g.Gh)();d[a]=e;lk(a,b,c)||(g.yk(!1,c),ek(c||"").tick[a]=b||(0,g.Gh)());return d[a]};
...
!0:!1:!1};
Jba=function(){Ek++;var a=g.Wc(),b=new g.zd(0,0,a.width,a.height);Ak("vph",a.height);Ak("vpw",a.width);g.tk("vpc");a=document.querySelectorAll(".yt-lockup-thumbnail img[data-ytimg]");var c=a.length,d=[];Gk.start();for(var e=0;e<c;e++){var f=a[e];Hk(f,b)&&(f=Eba(f),f.then(Fba),d.push(f),Ik.push(f))}g.tk("vpcc");b=g.Ne(d).then(Gba);g.Pe(b,Hba);b.then(Iba);Ik.push(b);return b};
...
Gba=function(a){var b=g.Wc();b=new g.zd(0,0,b.width,b.height);for(var c=0,d=0,e=a.length;d<e;d++){var f=a[d].time;Hk(a[d].ay,b)&&c<f&&(c=f)}return c};
Eba=function(a){var b=Ek;return new g.He(function(c,d){var e={ay:a,time:0};a.loadTime?(e.time=parseInt(a.loadTime,10),c(e)):(a.slt=function(){Ek!=b?d():(e.time=parseInt(a.loadTime,10),c(e),a.slt=void 0)},Lk.push(a))})};
...
aca=function(){g.Mj("PromptCount").then(function(a){return g.Lj("PromptCount",a+1)}).then(function(){return g.Lj("PromptTime",(0,g.Lc)())}).then(function(){var a=xg("service_worker_push_force_notification_prompt_tag");
...
eca=function(){var a=g.wg("service_worker_push_prompt_delay_microseconds");return a?g.Mj("PromptTime").then(function(b){return Promise.resolve((0,g.Lc)()-a>(b||0))}):Promise.resolve(!0)};
hca=function(){yl||xl()};
...
gca=function(){var a=g.z("yt-push-prompt-modal-bg");yl=g.vg("service_worker_push_prompt_modal_ignore_click");a?zl(a):(a=g.Zc("div",{id:"yt-push-prompt-modal-bg"}),zl(a),document.body.appendChild(a),g.oh(document,"click",hca))};
...
if("function"==typeof Object.setPrototypeOf)Dl=Object.setPrototypeOf;else{var El;a:{var nca={a:!0},Fl={};try{Fl.__proto__=nca;El=Fl.a;break a}catch(a){}El=!1}Dl=El?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var ha=Dl,ia=aaa(this),ja="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)};
...
return!0};g.rca=RegExp("[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.sca=RegExp("^[^\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc]*[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.Kl=RegExp("^[^A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]*[\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc]");var Wa,Xa,Ya,Za,$a,ab,gaa;g.db=String.prototype.trim?function(a){return a.trim()}:function(a){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(a)[1]};
...
var Xb={};g.cc("<!DOCTYPE html>",0);g.ue=g.cc("",0);g.Ql=g.cc("<br>",0);g.uca=g.Sa(function(){var a=document.createElement("div"),b=document.createElement("div");b.appendChild(document.createElement("div"));a.appendChild(b);b=a.firstChild.firstChild;a.innerHTML=g.Zb(g.ue);return!b.parentElement});g.jc=String.prototype.repeat?function(a,b){return a.repeat(b)}:function(a,b){return Array(b+1).join(a)};g.oc[" "]=g.xa;var Yl,jaa,bm;g.Rl=g.hb("Opera");g.Df=g.tb();g.Sl=g.hb("Edge");g.Tl=g.Sl||g.Df;g.Ul=g.hb("Gecko")&&!(g.cb(g.gb.toLowerCase(),"webkit")&&!g.hb("Edge"))&&!(g.hb("Trident")||g.hb("MSIE"))&&!g.hb("Edge");g.Vl=g.cb(g.gb.toLowerCase(),"webkit")&&!g.hb("Edge");g.Wl=g.hb("Macintosh");g.Xl=g.hb("Windows");g.vca=g.hb("Linux")||g.hb("CrOS");g.wca=g.hb("Android");g.xca=mc();g.yca=g.hb("iPad");g.zca=g.hb("iPod");g.Aca=g.nc();
...
g.h.valueOf=function(){return this.date.valueOf()};var maa;maa=!g.Df||g.uc(9);g.Cca=!g.Ul&&!g.Df||g.Df&&g.uc(9)||g.Ul&&g.sc("1.9.1");g.km=g.Df&&!g.sc("9");g.Dca=g.Df||g.Rl||g.Vl;g.h=g.Nc.prototype;g.h.clone=function(){return new g.Nc(this.x,this.y)};
...
g.h.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};var Tc={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",nonce:"nonce",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};g.id=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/\\#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;g.td=/#|$/;var Eca={IJ:"allow-forms",JJ:"allow-modals",KJ:"allow-orientation-lock",LJ:"allow-pointer-lock",MJ:"allow-popups",NJ:"allow-popups-to-escape-sandbox",OJ:"allow-presentation",PJ:"allow-same-origin",QJ:"allow-scripts",RJ:"allow-top-navigation",SJ:"allow-top-navigation-by-user-activation"},oaa=g.Sa(function(){return g.xd(Eca)});g.ya(g.yd);g.h=g.zd.prototype;g.h.clone=function(){return new g.zd(this.left,this.top,this.width,this.height)};
...
g.h.round=function(){this.left=Math.round(this.left);this.top=Math.round(this.top);this.width=Math.round(this.width);this.height=Math.round(this.height);return this};g.lm=g.Ul?"MozUserSelect":g.Vl||g.Sl?"WebkitUserSelect":null;g.mm=!!window.google_async_iframe_id;g.nm=g.mm&&window.parent||window;g.Hb(g.Cb("//fonts.googleapis.com/css"));g.Ig=(new Date).getTime();Md.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.C[a]!=b&&(this.C[a]=b,this.F=-1)};
...
g.C.prototype.W=function(){if(this.wf)for(;this.wf.length;)this.wf.shift()()};g.Td.prototype.stopPropagation=function(){this.F=!0};
g.Td.prototype.preventDefault=function(){this.defaultPrevented=!0};var ie,Gca,waa;g.Fca=!g.Df||g.uc(9);ie=!g.Df||g.uc(9);Gca=g.Df&&!g.sc("9");waa=function(){if(!g.p.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
try{g.p.addEventListener("test",g.xa,b),g.p.removeEventListener("test",g.xa,b)}catch(c){}return a}();g.om=g.Vl?"webkitTransitionEnd":g.Rl?"otransitionend":"transitionend";g.x(g.Ud,g.Td);var Hca={2:"touch",3:"pen",4:"mouse"};
...
var Xe=te;g.x(g.Ve,g.Ha);g.Ve.prototype.name="cancel";g.x(g.$e,g.C);g.h=g.$e.prototype;g.h.pb=0;g.h.W=function(){g.$e.V.W.call(this);this.stop();delete this.C;delete this.F};
...
g.h.xk=function(){this.pb=0;this.C&&this.C.call(this.F)};g.x(af,Daa);af.prototype.reset=function(){this.C[0]=1732584193;this.C[1]=4023233417;this.C[2]=2562383102;this.C[3]=271733878;this.C[4]=3285377520;this.H=this.D=0};
...
g.vm="Microsoft Internet Explorer"==navigator.appName;g.x(g.qh,g.C);g.qh.prototype.Y=function(a){this.C=new g.Nc(g.fh(a),g.gh(a))};
g.qh.prototype.N=function(){if(this.C){var a=g.um();if(0!=this.D){var b=g.Pc(this.L,this.C)/(a-this.D);this.F[this.H]=.5<Math.abs((b-this.G)/this.G)?1:0;for(var c=0,d=0;4>d;d++)c+=this.F[d]||0;3<=c&&this.Pb();this.G=b}this.D=a;this.L=this.C;this.H=(this.H+1)%4}};
g.qh.prototype.W=function(){g.Zf(this.M);g.nh(this.J)};g.n(rh,g.C);rh.prototype.Va=function(a){for(var b=0;b<this.C.length;b++)if(this.C[b]==a){this.C.splice(b,1);a.target.removeEventListener(a.name,a.callback);break}};
rh.prototype.W=function(){for(;this.C.length;){var a=this.C.pop();a.target.removeEventListener(a.name,a.callback)}g.C.prototype.W.call(this)};sh.prototype.clone=function(){var a=new sh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==g.za(c)?a[b]=g.pb(c):a[b]=c}return a};g.n(g.uh,Error);g.wm=new Set;var dba,Oh,Ph,Qh,eba,Hh,fba,Ah,Bh;dba=g.wg("initial_gel_batch_timeout",1E3);Oh=Math.pow(2,16)-1;g.Zh=10;Ph=null;Qh=0;eba={log_event:"events",log_interaction:"interactions"};Hh=Object.create(null);Hh.log_event="GENERIC_EVENT_LOGGING";Hh.log_interaction="INTERACTION_LOGGING";fba=new Set(["log_event"]);Ah={};g.xh=0;g.yh=0;g.Yh=0;Bh=!0;g.zh=g.u("ytLoggingTransportLogPayloadsQueue_")||{};g.r("ytLoggingTransportLogPayloadsQueue_",g.zh,void 0);var Nh=g.u("ytLoggingTransportTokensToCttTargetIds_")||{};
...
g.h.loadNewVideoConfig=function(a){if(!this.qb()){this.aa&&(g.Yf(this.aa),this.aa=0);this.ob=a=g.th(a);this.C=a.clone();tj(this);this.qa||(this.qa=Ej(this,this.C.args.jsapicallback||"onYouTubePlayerReady"));this.C.args.jsapicallback=null;(a=this.C.attrs.width)&&g.Bd(this.L,Number(a)||a);if(a=this.C.attrs.height)this.L.style.height=g.Ad(Number(a)||a,!0);uj(this);this.N&&wj(this)}};
...
pl),window.addEventListener("spfjsbeforeunload",Cl)),a.config=a.config||{},window.ytdepmap?spf.script.ready("spf",function(){a.enabled=spf.init(a.config)}):a.enabled=spf.init(a.config),this.subscribe("init",Wba),this.subscribe("dispose",Xba)):spf.dispose();
this.subscribe("init",this.init,this);this.subscribe("dispose",this.dispose,this)};
Bl.prototype.init=function(){Bl.V.init.call(this);(window.ytspf||{}).enabled||spf.dispose();var a=window.ytPageFrameLoaded||!1;if(!a&&g.E("PAGEFRAME_JS")){var b=g.E("PAGEFRAME_JS",void 0);var c=function(){var e=g.u("ytbin.www.pageframe.setup");e&&(window.ytPageFrameLoaded=!0,e())}}else a&&(a=g.u("yt.www.masthead.loadSearchbox"))&&a();
a=g.E("JS_COMMON_MODULE");var d=g.E("JS_PAGE_MODULES");d||(d=[a]);a=g.E("JS_DELAY_LOAD",0);0<a?(g.Yf(this.D),this.D=g.Wf(function(){b&&g.ig(b,c);spf.script.require(d)},a)):(b&&g.ig(b,c),spf.script.require(d));
